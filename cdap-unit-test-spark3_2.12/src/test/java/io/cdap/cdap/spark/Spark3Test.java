...
import io.cdap.cdap.spark.app.PythonSpark3;
...
import io.cdap.cdap.spark.app.Spark3TestApp;
...
import io.cdap.cdap.test.TestBaseWithSpark3;
 ...
 *
 */
public class Spark3Test extends TestBaseWithSpark3 {
  ...
  public static void init() throws IOException {
    ...
    ARTIFACTS.put(Spark3TestApp.class, createArtifactJar(Spark3TestApp.class));
  }

  @Test
  public void testSpark3Service() throws Exception {
    ApplicationManager applicationManager = deploy(NamespaceId.DEFAULT, Spark3TestApp.class);
  ...
  public void testPySpark() throws Exception {
    ApplicationManager appManager = deploy(NamespaceId.DEFAULT, Spark3TestApp.class);
    ...
    appManager.getSparkManager(PythonSpark3.class.getSimpleName())
    ...
    final Map<String, String> tags = ImmutableMap.of(
      ...
      Constants.Metrics.Tag.APP, Spark3TestApp.class.getSimpleName(),
      Constants.Metrics.Tag.SPARK, PythonSpark3.class.getSimpleName());
