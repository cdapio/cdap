 ...
 * the License.
 */
package co.cask.cdap.data2.transaction.queue.coprocessor.hbase10cdh550;
...
public final class HBaseQueueRegionObserver extends BaseRegionObserver {
  ...
  public void start(CoprocessorEnvironment env) {
    if (env instanceof RegionCoprocessorEnvironment) {
      ...
      HTable10CDH550NameConverter nameConverter = new HTable10CDH550NameConverter();
      ...
      String queueConfigTableId = HBaseQueueAdmin.getConfigTableId();
