...
public class StructuredRecord implements Serializable {
  ...
  /**
   * Get the {@link LocalDate} from field. The field must have {@link LogicalType#DATE} as its
   * logical type.
   *
   * @param fieldName date field to get.
   * @return value of the field as a {@link LocalDate}
   * @throws UnexpectedFormatException if the provided field is not of {@link LogicalType#DATE}
   *     type.
   */
  @Nullable
  public LocalDate getDate(String fieldName) {
    ...
    try {
      ...
      return (value == null || logicalTypeSchema == null) ? null
          : LocalDate.ofEpochDay(value.longValue());
  ...
  /**
   * Get {@link LocalTime} from field. The field must have {@link LogicalType#TIME_MILLIS} or {@link
   * LogicalType#TIME_MICROS} as its logical type.
   *
   * @param fieldName time field to get.
   * @return value of the field as a {@link LocalTime}
   * @throws UnexpectedFormatException if the provided field is not of {@link
   *     LogicalType#TIME_MILLIS} or {@link LogicalType#TIME_MICROS} type.
   */
  @Nullable
   ...
   * {@link Schema.LogicalType#TIMESTAMP_MILLIS} or {@link Schema.LogicalType#TIMESTAMP_MICROS} as
   * its logical type.
   *
   * @param fieldName zoned date time field to get.
   * @return value of the field as a {@link ZonedDateTime}
   * @throws UnexpectedFormatException if the provided field is not of {@link
   *     LogicalType#TIMESTAMP_MILLIS} or {@link LogicalType#TIMESTAMP_MICROS} type.
   */
  @Nullable
  ...
  /**
   * Get the {@link ZonedDateTime} with provided timezone. The field must have {@link
   * Schema.LogicalType#TIMESTAMP_MILLIS} or {@link Schema.LogicalType#TIMESTAMP_MICROS} as its
   * logical type.
   *
   * @param fieldName zoned date time field to get.
  ...
  /**
   * Get the {@link BigDecimal} from field. The field must have {@link LogicalType#DECIMAL} as its
   * logical type.
   *
   * @param fieldName decimal field to get.
   * @return value of the field as a {@link BigDecimal}
   * @throws UnexpectedFormatException if the provided field is not of {@link
   *     LogicalType#DECIMAL} type.
   */
  @Nullable
  public BigDecimal getDecimal(String fieldName) {
    ...
    try {
      ...
      throw new ClassCastException(
          String.format("Field '%s' is expected to be a decimal, but is a %s.", fieldName,
              value.getClass().getSimpleName()));
    }
  }

  /**
   * Returns value of a datetime field as java.time.LocalDateTime formatted using {@link
   * java.time.format.DateTimeFormatter#ISO_LOCAL_DATE_TIME}. Use get() to retrieve value as
   * string.
   *
  ...
  public LocalDateTime getDateTime(String fieldName) {
    ...
    try {
      ...
      throw new UnexpectedFormatException(
          String.format("Field '%s' with value '%s' is not a valid datetime in ISO-8601 format",
              fieldName,
              value.toString()));
    }
  }
  ...
  /**
   * Validates and returns the underlying {@link LogicalType} Schema of the given {@link
   * Schema.Field}.
   *
   ...
   * @throws UnexpectedFormatException if the field provided does not have a {@link LogicalType}
   *     that is one of the acceptable types
   */
  @Nullable
  private static Schema validateAndGetLogicalTypeSchema(Schema.Field field,
      Set<LogicalType> allowedTypes) {
    if (field == null) {
      return null;
    }
    ...
    if (logicalTypeSchema == null) {
      throw new UnexpectedFormatException(
          String.format("Field %s does not have a logical type.", fieldName));
    }

    LogicalType logicalType = logicalTypeSchema.getLogicalType();
    if (!allowedTypes.contains(logicalType)) {
      throw new UnexpectedFormatException(
          String.format("Field %s must be of logical type %s, instead it is of type %s",
  ...
  /**
   * Gets the {@link Schema} with logical type. If the given {@link Schema} is a {@link
   * Schema.Type#UNION}, this method will find the schema recursively and return the schema for the
   * first {@link LogicalType} it encountered.
   *
   ...
   * @throws UnexpectedFormatException if the given schema is not a record with at least one
   *     field.
   */
  ...
  public static class Builder {
     ...
     * @return this builder
     * @throws UnexpectedFormatException if the field is not in the schema, or the field is not
     *     nullable but a null value is given
     */
     ...
     * @return this builder
     * @throws UnexpectedFormatException if the field is not in the schema, or the field is not
     *     nullable but a null value is given or if the provided date is an invalid date
     */
    public Builder setDate(String fieldName, @Nullable LocalDate localDate) {
      validateAndGetLogicalTypeSchema(validateAndGetField(fieldName, localDate),
          EnumSet.of(LogicalType.DATE));
      if (localDate == null) {
      ...
      try {
        ...
        throw new UnexpectedFormatException(
            String.format("Field %s was set to a date that is too large." +
    ...
    /**
     * Sets the time value for {@link LogicalType#TIME_MILLIS} or {@link LogicalType#TIME_MICROS}
     * field
     *
     * @param fieldName name of the field to set
    ...
    public Builder setTime(String fieldName, @Nullable LocalTime localTime) {
      Schema logicalTypeSchema = validateAndGetLogicalTypeSchema(
      ...
      if (logicalTypeSchema.getLogicalType() == LogicalType.TIME_MILLIS) {
        try {
          ...
          throw new UnexpectedFormatException(
              String.format("Field %s was set to a time that is too large.",
                  fieldName));
        }
        return this;
      }
    ...
    /**
     * Sets the timestamp value for {@link LogicalType#TIMESTAMP_MILLIS} or {@link
     * LogicalType#TIMESTAMP_MICROS} field
     *
     * @param fieldName name of the field to set
     * @param zonedDateTime value for the field
     * @return this builder
     * @throws UnexpectedFormatException if the field is not in the schema, or the field is not
     *     nullable but a null value is given or if the provided date is an invalid timestamp
     */
    public Builder setTimestamp(String fieldName, @Nullable ZonedDateTime zonedDateTime) {
      ...
      try {
        ...
        throw new UnexpectedFormatException(
            String.format("Field %s was set to a timestamp that is too large.",
                fieldName));
      }
    }

    /**
     * Sets the decimal value for provided {@link LogicalType#DECIMAL} field. The decimal value
     * precision should be less than or equal to precision provided in {@link Schema.LogicalType}
     * and the scale should be exactly same.
     *
     * @param fieldName name of the field to set
     * @param decimal value for the field
     * @return this builder
     * @throws UnexpectedFormatException if the field is not in the schema, or the field is not
     *     nullable but a null value is given or if the provided decimal is invalid
     */
    public Builder setDecimal(String fieldName, @Nullable BigDecimal decimal) {
      Schema logicalSchema = validateAndGetLogicalTypeSchema(
          validateAndGetField(fieldName, decimal),
          EnumSet.of(LogicalType.DECIMAL));
      if (decimal == null) {
        fields.put(fieldName, null);
        return this;
      ...
      if (decimal.precision() > logicalSchema.getPrecision()) {
        throw new UnexpectedFormatException(
            String.format(
                "Field '%s' has precision '%s' which is higher than schema precision '%s'.",
    ...
    /**
     * Convert the given date into the type of the given field, and set the value for that field. A
     * Date can be converted into a long or a string. This method does not support {@link
     * LogicalType#DATE}
     *
     * @param fieldName name of the field to set
     ...
     * @return this builder
     * @throws UnexpectedFormatException if the field is not in the schema, or the field is not
     *     nullable but a null value is given, or the date cannot be converted to the type for the
     *     field
     * @deprecated As of release 5.1.0, use {@link StructuredRecord.Builder#setDate(String,
     *     LocalDate)} instead.
     */
    @Deprecated
    ...
    /**
     * Convert the given date into the type of the given field, and set the value for that field. A
     * Date can be converted into a long or a string, using a date format, if supplied. This method
     * does not support {@link LogicalType#DATE}
     *
     * @param fieldName name of the field to set
     * @param date date value for the field
    ...
    public Builder convertAndSet(String fieldName, @Nullable Date date,
      ...
      Schema.Type fieldType =
          isNullable ? field.getSchema().getNonNullable().getType() : field.getSchema().getType();
      if (fieldType == Schema.Type.LONG) {
        ...
        throw new UnexpectedFormatException(
            "Date must be either a long or a string, not a " + fieldType);
      }
      return this;
    }
     ...
     * A String can be converted to a boolean, int, long, float, double, bytes, string, or null.
     *
     * @param fieldName name of the field to set
     * @param strVal string value for the field
     * @return this builder
     * @throws UnexpectedFormatException if the field is not in the schema, or the field is not
     *     nullable but a null value is given, or the string cannot be converted to the type for the
     *     field
     */
    public Builder convertAndSet(String fieldName, @Nullable String strVal)
        throws UnexpectedFormatException {
     ...
     * @throws UnexpectedFormatException if there is at least one non-nullable field without a
     *     value
     */
    ...
    private Schema.Field validateAndGetField(String fieldName, Object val) {
      ...
      if (val == null) {
        ...
        if (fieldSchema.getType() != Schema.Type.UNION) {
          throw new UnexpectedFormatException(
              "field " + fieldName + " cannot be set to a null value.");
        }
