...
public class DescribeAppCommand extends AbstractAuthCommand {
  ...
  public void perform(Arguments arguments, PrintStream output) throws Exception {
    ...
    List<ProgramDetail> programsList = applicationClient.listPrograms(appId);

    Table table = Table.builder()
      .setHeader("app", "type", "id", "description")
      .setRows(programsList, new RowMaker<ProgramDetail>() {
        @Override
        public List<?> makeRow(ProgramDetail object) {
