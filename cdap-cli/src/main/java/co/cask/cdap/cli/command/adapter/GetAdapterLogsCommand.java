...
/**
 * Gets the logs of an adapter.
 */
public class GetAdapterLogsCommand extends AbstractAuthCommand {

  private final AdapterClient adapterClient;

  @Inject
  public GetAdapterLogsCommand(AdapterClient adapterClient, CLIConfig cliConfig) {
    super(cliConfig);
  ...
  public String getPattern() {
    return String.format("get adapter logs <%s>", ArgumentName.ADAPTER);
  }
