 ...
 *
 * @deprecated since 4.1.0. Use {@link LoadPreferencesCommand} instead.
 */
@Deprecated
public class LoadPreferencesDeprecatedCommand extends AbstractSetPreferencesCommand {
  ...
  protected LoadPreferencesDeprecatedCommand(ElementType type, PreferencesClient client, CLIConfig cliConfig) {
