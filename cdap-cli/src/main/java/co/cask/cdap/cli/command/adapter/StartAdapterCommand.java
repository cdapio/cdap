 ...
 * Starts an adapter.
 */
public class StartAdapterCommand extends AbstractAuthCommand {

  private final AdapterClient adapterClient;

  @Inject
  public StartAdapterCommand(AdapterClient adapterClient, CLIConfig cliConfig) {
    super(cliConfig);
  ...
  public String getPattern() {
    return String.format("start adapter <%s>", ArgumentName.ADAPTER);
  }
