 ...
 *
 */
public class SetPreferencesNewCommand extends AbstractSetPreferencesCommand {
  protected static final String SUCCESS = "Set preferences successfully for the '%s'";
  private final ElementType type;

  protected SetPreferencesNewCommand(ElementType type, PreferencesClient client, CLIConfig cliConfig) {
