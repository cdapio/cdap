...
public class GrantActionCommand extends AbstractAuthCommand {
  ...
  public void perform(Arguments arguments, PrintStream output) throws Exception {
    ...
    client.grant(entity, user, actions);
    output.printf("Successfully granted action(s) '%s' on entity '%s' for user '%s'\n",
  ...
  public String getDescription() {
    return "Grants a user permission to perform certain actions on an entity. <actions> is a comma-separated list.";
  }
