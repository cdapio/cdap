  ...
  public ApplicationTemplateCommands(Injector injector) {
    super(
      ImmutableList.<Command>builder()
        .add(injector.getInstance(DescribeAppTemplateCommand.class))
        .add(injector.getInstance(GetAppTemplatePluginsCommand.class))
        .add(injector.getInstance(ListAppTemplatesCommand.class))
        .build());
  }
