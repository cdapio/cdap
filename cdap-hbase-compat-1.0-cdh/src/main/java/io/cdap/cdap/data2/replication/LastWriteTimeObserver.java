...
public class LastWriteTimeObserver extends BaseWALObserver {
  ...
  private HBase10CDHTableUpdater hBase10CDHTableUpdater;
  ...
  public void start(CoprocessorEnvironment env) throws IOException {
    ...
    hBase10CDHTableUpdater = new HBase10CDHTableUpdater(
  ...
  public void postWALWrite(ObserverContext<? extends WALCoprocessorEnvironment> ctx,
    ...
    hBase10CDHTableUpdater.updateTime(new String(logKey.getEncodedRegionName(), "UTF-8"),
        logKey.getWriteTime());
  }
}
