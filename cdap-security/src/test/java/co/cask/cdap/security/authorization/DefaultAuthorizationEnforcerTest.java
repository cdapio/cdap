...
//        new DefaultAuthorizationEnforcer(authorizerInstantiator.get(), cConfCopy, AUTH_CONTEXT);
...
//      DefaultAuthorizationEnforcer authEnforcementService =
//        new DefaultAuthorizationEnforcer(authorizer, CCONF, AUTH_CONTEXT);
//      authEnforcementService.startAndWait();
//      try {
...
//    DefaultAuthorizationEnforcer authorizationEnforcementService =
//      new DefaultAuthorizationEnforcer(new FailingPrivilegesFetcher(countDownLatch), cConfCopy, AUTH_CONTEXT);
...
//      Authorizer authorizer = authorizerInstantiator.get();
//      DefaultAuthorizationEnforcer authorizationEnforcementService =
//        new DefaultAuthorizationEnforcer(authorizer, cConfCopy, AUTH_CONTEXT);
//      NamespaceId ns1 = new NamespaceId("ns1");
...
//    final DefaultAuthorizationEnforcer authorizationEnforcementService) throws Exception {
...
//    try (AuthorizerInstantiator authorizerInstantiator = new AuthorizerInstantiator(cConf, AUTH_CONTEXT_FACTORY)) {
//      DefaultAuthorizationEnforcer authEnforcementService =
//        new DefaultAuthorizationEnforcer(authorizerInstantiator.get(), cConf, AUTH_CONTEXT);
//      authEnforcementService.startAndWait();
//      try {
//        DatasetId ds = NS.dataset("ds");
//        Assert.assertTrue(authEnforcementService.getCache().isEmpty());
