 ...
 */
public class SecureStoreService extends AbstractIdleService implements SecureStoreManager, SecureStore {
  private static final Logger LOG = LoggerFactory.getLogger(SecureStoreService.class);
  ...
  @Inject
  public SecureStoreService(CConfiguration cConf, NamespaceQueryAdmin namespaceQueryAdmin) {
