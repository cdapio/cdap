 ...
 *
 * The {@link AuthorizationService} has the following expectations from the extension:
 * <ul>
...
public class AuthorizationService extends AbstractIdleService {
  ...
  public AuthorizationService(CConfiguration cConf, AuthorizationContextFactory authorizationContextFactory) {
    this.cConf = cConf;
