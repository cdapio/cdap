...
public abstract class BufferingTableTest<T extends BufferingTable>
  ...
  public void testRollingBackAfterExceptionDuringPersist() throws Exception {
    ...
    try {
      ...
      TableAssert.verify(a(C2, V2), myTable1.get(R2, a(C2)));
      ...
      TableAssert.verify(a(), myTable2.get(R2, a(C2)));
  ...
  public void testScanWithBuffering() throws Exception {
    ...
    try {
      ...
      TableAssert.verify(a(Bytes.toBytes("1_01"), Bytes.toBytes("1_02"), Bytes.toBytes("1_03")),
                         aa(a(C1, V1),
                            a(C1, V1),
                            a(C1, V1)),
      ...
      TableAssert.verify(a(Bytes.toBytes("1_01"), Bytes.toBytes("1_02"), Bytes.toBytes("1_02a"), Bytes.toBytes("1_02b"),
