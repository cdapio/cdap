...
public class RemoteDatasetFrameworkTest extends AbstractDatasetFrameworkTest {
  ...
  @Test
  public void testSystemNamespace() throws DatasetManagementException, ServiceNotRunningException {
  ...
  @After
  public void after() throws DatasetManagementException, ServiceNotRunningException {
