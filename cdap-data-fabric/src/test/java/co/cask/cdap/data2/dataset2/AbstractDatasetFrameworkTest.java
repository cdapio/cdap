...
public abstract class AbstractDatasetFrameworkTest {
  ...
  protected abstract DatasetFramework getFramework() throws DatasetManagementException, ServiceNotRunningException;
  ...
  @Test
  public void testNamespaceCreationDeletion() throws DatasetManagementException, ServiceNotRunningException {
    DatasetFramework framework = getFramework();
