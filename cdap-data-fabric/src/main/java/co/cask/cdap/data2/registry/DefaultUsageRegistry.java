...
/**
 * Default implementation of {@link UsageRegistry}.
 */
public class DefaultUsageRegistry implements UsageRegistry {
  ...
  @Inject
  public DefaultUsageRegistry(TransactionExecutorFactory txExecutorFactory, final DatasetFramework datasetFramework) {
