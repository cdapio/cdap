...
public class ConsumerConfigCacheSupplier implements CacheSupplier<ConsumerConfigCache> {
  private static final ReferenceCountedSupplier<ConsumerConfigCache> referenceCountedSupplier
    = new ReferenceCountedSupplier<>(ConsumerConfigCache.class.getSimpleName());

  private final Supplier<ConsumerConfigCache> supplier;

  public ConsumerConfigCacheSupplier(final TableName queueConfigTableName, final CConfigurationReader cConfReader,
    ...
    this.supplier = new Supplier<ConsumerConfigCache>() {
      ...
      public ConsumerConfigCache get() {
        return new ConsumerConfigCache(queueConfigTableName, cConfReader, transactionSnapshotSupplier, hTableSupplier);
      }
    };
  }
