...
class DatasetServiceClient {
  ...
  @Nullable
  public DatasetMeta getInstance(String instanceName) throws DatasetManagementException, ServiceNotRunningException {
  ...
  public void deleteInstance(String datasetInstanceName) throws DatasetManagementException, ServiceNotRunningException {
  ...
  public void deleteModule(String moduleName) throws DatasetManagementException, ServiceNotRunningException {
  ...
  public void deleteModules() throws DatasetManagementException, ServiceNotRunningException {
  ...
  public void createNamespace() throws DatasetManagementException, ServiceNotRunningException {
  ...
  public void deleteNamespace() throws DatasetManagementException, ServiceNotRunningException {
  ...
  private HttpResponse doDelete(String resource) throws DatasetManagementException, ServiceNotRunningException {
    return doRequest(HttpMethod.DELETE, resource);
  }

  private HttpResponse doRequest(HttpMethod method, String resource,
                                 @Nullable Multimap<String, String> headers,
                                 @Nullable String body) throws DatasetManagementException, ServiceNotRunningException {
  ...
  private String resolve(String resource) throws DatasetManagementException, ServiceNotRunningException {
    Discoverable discoverable = endpointStrategySupplier.get().pick(1, TimeUnit.SECONDS);
    if (discoverable == null) {
      throw new ServiceNotRunningException("DatasetService");
    }
