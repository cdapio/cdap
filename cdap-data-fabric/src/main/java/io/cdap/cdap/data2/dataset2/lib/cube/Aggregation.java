 ...
 * {@link io.cdap.cdap.api.dataset.lib.cube.CubeFact} when it is
 * added to the {@link io.cdap.cdap.api.dataset.lib.cube.Cube}. Configuring a
 * {@link io.cdap.cdap.api.dataset.lib.cube.Cube} to compute an aggregation allows later querying for data based
 * on those dimensions the data is aggregated for. See also {@link io.cdap.cdap.api.dataset.lib.cube.CubeQuery}.
 */
public interface Aggregation {
  /**
   * Defines the dimensions to do the aggregation for.
   * <p/>
   * Depending on the implementation of a {@link io.cdap.cdap.api.dataset.lib.cube.Cube},
   ...
   * (dimensions with values to slice by in {@link io.cdap.cdap.api.dataset.lib.cube.CubeQuery} to be in front.
   *
  ...
  /**
   * Filters out {@link io.cdap.cdap.api.dataset.lib.cube.CubeFact}s which should not be added into this aggregation.
