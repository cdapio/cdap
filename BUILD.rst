...
- Build Standalone distribution ZIP::
    ...
    MAVEN_OPTS="-Xmx2048m -XX:MaxPermSize=128m" mvn package -pl cdap-standalone,cdap-app-templates/cdap-etl,cdap-examples -am -amd -DskipTests -P examples,templates,dist,release,unit-tests
