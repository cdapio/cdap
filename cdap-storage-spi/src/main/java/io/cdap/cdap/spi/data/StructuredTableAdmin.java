...
public interface StructuredTableAdmin {
   ...
   *                                          existing one
   */
  default List<String> createOrUpdate(StructuredTableSpecification spec)
  ...
  /**
   * execute performs the ddl statements operations.
   *
   * @param ddlStatements createTable operations.
   * @throws IOException if there is an error creating table
   */
  void execute(List<String> ddlStatements) throws IOException;
