...
public class IncrementTxFilter extends TransactionVisibilityFilter {
   ...
   *     If null, then {@link Filter.ReturnCode#INCLUDE_AND_NEXT_COL} will be returned instead.
   */
  ...
  @Override
  protected Filter.ReturnCode determineReturnCode(Filter.ReturnCode txFilterCode,
      Filter.ReturnCode subFilterCode) {
    switch (subFilterCode) {
      ...
      case SKIP:
        return txFilterCode == Filter.ReturnCode.INCLUDE ? Filter.ReturnCode.SKIP
