...
version = get_sdk_version() # '2.4.0'
# The full version, including alpha/beta/rc tags.
release = get_sdk_version() # '2.4.0'
...
man_pages = [
    ('index', 'reactor', u'Reactor Documentation',
     [u'Continuuity Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Reactor', u'Reactor Documentation',
   u'Continuuity Inc.', 'Reactor', 'One line description of project.',
   'Miscellaneous'),
]
...
pdf_documents = [
    ('index', u'Reactor', u'Continuuity Reactor', u'Continuuity, Inc.'),
]
