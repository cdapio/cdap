...
function build_license_pdfs() {
  ...
  LIC1_SOURCE="$SOURCE_PATH/licenses/reactor-enterprise-dependencies.rst"
  LIC1_PDF="$SCRIPT_PATH/$LICENSES_PDF/reactor-enterprise-dependencies.pdf"
  python $DOCS_PY -g pdf -o $LIC1_PDF $LIC1_SOURCE

  LIC2_SOURCE="$SOURCE_PATH/licenses/reactor-level-1-dependencies.rst"
  LIC2_PDF="$SCRIPT_PATH/$LICENSES_PDF/reactor-level-1-dependencies.pdf"
