...
- Pass headers for the event as HTTP headers,
  prefixing them with the *stream-id*: |br_m07|
...
Reading Events from a Stream: |br_m07| Getting a Consumer-ID
============================================================
|br_m07|
...
Reading Events from a Stream: |br_m07| Getting a Consumer-ID: Example
=====================================================================
|br_m07|
...
- The ``Consumer-ID`` is returned in a response header
  and in the body of the response: |br2_m07|
  ``X-Continuuity-ConsumerId: <consumer-id>`` |br2_m07|
- Once you have the ``Consumer-ID``, single events can be read from the Stream

----

Reading Events from a Stream: |br_m07| Using the Consumer-ID
=============================================================
|br_m07| 
...
Reading Events from a Stream: |br_m07| Using the Consumer-ID: Example
=====================================================================
|br_m07|
...
Reading Events from a Stream: the Response
==========================================
