...
Homepage.prototype.enableIntervals = function () {
  ...
  this.interval = setInterval(function() {
    $.ajax({
      url: '/v2/apps/SentimentAnalysis/procedures/sentiment-query/methods/aggregates',
      type: 'GET',
      contentType: "application/json",
      cache: false,
      dataType: 'json',
    ...
    $.ajax({
      url: '/v2/apps/SentimentAnalysis/procedures/sentiment-query/methods/sentiments?sentiment=positive',
      type: 'GET',
      contentType: "application/json",
      dataType: 'json',
      cache: false,
    ...
    $.ajax({
      url: '/v2/apps/SentimentAnalysis/procedures/sentiment-query/methods/sentiments?sentiment=neutral',
      type: 'GET',
      contentType: "application/json",
      dataType: 'json',
      cache: false,
    ...
    $.ajax({
      url: '/v2/apps/SentimentAnalysis/procedures/sentiment-query/methods/sentiments?sentiment=negative',
      type: 'GET',
      contentType: "application/json",
      dataType: 'json',
      cache: false,
