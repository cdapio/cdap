...
package co.cask.cdap.data2.transaction.messaging.coprocessor.hbase20;
...
import co.cask.cdap.data2.util.hbase.HBase20ScanBuilder;
 ...
 *
 */
public class MessageTableRegionObserver implements RegionCoprocessor,RegionObserver {
