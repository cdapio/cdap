...
public class DefaultHBase20DDLExecutor extends DefaultHBaseDDLExecutor {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(DefaultHBase20DDLExecutor.class);

  @Override
  public HTableDescriptor getHTableDescriptor(TableDescriptor descriptor) {
    return HBase20TableDescriptorUtil.getHTableDescriptor(descriptor);
  }

  @Override
  public TableDescriptor getTableDescriptor(HTableDescriptor descriptor) {
    return HBase20TableDescriptorUtil.getTableDescriptor(descriptor);
  }
