 ...
 */
public class LastReplicateTimeObserver implements RegionServerObserver, Coprocessor {
  ...
  public void start(CoprocessorEnvironment env) throws IOException {
    ...
    hBase20TableUpdater = new HBase20TableUpdater(ReplicationConstants.ReplicationStatusTool.REPLICATE_TIME_ROW_TYPE,
