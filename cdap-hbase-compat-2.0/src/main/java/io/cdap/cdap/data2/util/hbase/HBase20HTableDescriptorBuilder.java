 ...
 */
public class HBase20HTableDescriptorBuilder extends HTableDescriptorBuilder {
  HBase20HTableDescriptorBuilder(TableName tableName) {
    super(tableName);
  }

  HBase20HTableDescriptorBuilder(HTableDescriptor descriptorToCopy) {
