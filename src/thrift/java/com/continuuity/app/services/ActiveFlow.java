...
public class ActiveFlow implements org.apache.thrift.TBase<ActiveFlow, ActiveFlow._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unsetLastStopped() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LASTSTOPPED_ISSET_ID);
  }

  /** Returns true if field lastStopped is set (has been assigned a value) and false otherwise */
  public boolean isSetLastStopped() {
    return EncodingUtils.testBit(__isset_bitfield, __LASTSTOPPED_ISSET_ID);
  }

  public void setLastStoppedIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LASTSTOPPED_ISSET_ID, value);
  }
  ...
  public void unsetLastStarted() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LASTSTARTED_ISSET_ID);
  }

  /** Returns true if field lastStarted is set (has been assigned a value) and false otherwise */
  public boolean isSetLastStarted() {
    return EncodingUtils.testBit(__isset_bitfield, __LASTSTARTED_ISSET_ID);
  }

  public void setLastStartedIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LASTSTARTED_ISSET_ID, value);
  }
  ...
  public void unsetRuns() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __RUNS_ISSET_ID);
  }

  /** Returns true if field runs is set (has been assigned a value) and false otherwise */
  public boolean isSetRuns() {
    return EncodingUtils.testBit(__isset_bitfield, __RUNS_ISSET_ID);
  }

  public void setRunsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __RUNS_ISSET_ID, value);
  }
