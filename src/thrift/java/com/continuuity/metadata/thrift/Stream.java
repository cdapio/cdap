...
public class Stream implements org.apache.thrift.TBase<Stream, Stream._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new StreamStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StreamTupleSchemeFactory());
  }
  ...
  public void unsetCapacityInBytes() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __CAPACITYINBYTES_ISSET_ID);
  }
  ...
  public boolean isSetCapacityInBytes() {
    return EncodingUtils.testBit(__isset_bitfield, __CAPACITYINBYTES_ISSET_ID);
  }

  public void setCapacityInBytesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __CAPACITYINBYTES_ISSET_ID, value);
  }
  ...
  public void unsetExpiryInSeconds() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __EXPIRYINSECONDS_ISSET_ID);
  }
  ...
  public boolean isSetExpiryInSeconds() {
    return EncodingUtils.testBit(__isset_bitfield, __EXPIRYINSECONDS_ISSET_ID);
  }

  public void setExpiryInSecondsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __EXPIRYINSECONDS_ISSET_ID, value);
  }
  ...
  private static class StreamStandardSchemeFactory implements SchemeFactory {
    public StreamStandardScheme getScheme() {
      return new StreamStandardScheme();
    }
  }

  private static class StreamStandardScheme extends StandardScheme<Stream> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // CAPACITY_IN_BYTES
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.capacityInBytes = iprot.readI64();
              struct.setCapacityInBytesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 5: // EXPIRY_IN_SECONDS
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.expiryInSeconds = iprot.readI64();
              struct.setExpiryInSecondsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Stream struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCapacityInBytes()) {
        oprot.writeFieldBegin(CAPACITY_IN_BYTES_FIELD_DESC);
        oprot.writeI64(struct.capacityInBytes);
        oprot.writeFieldEnd();
      }
      if (struct.isSetExpiryInSeconds()) {
        oprot.writeFieldBegin(EXPIRY_IN_SECONDS_FIELD_DESC);
        oprot.writeI64(struct.expiryInSeconds);
        oprot.writeFieldEnd();
      }
  ...
  private static class StreamTupleSchemeFactory implements SchemeFactory {
    public StreamTupleScheme getScheme() {
      return new StreamTupleScheme();
    }
  }

  private static class StreamTupleScheme extends TupleScheme<Stream> {
