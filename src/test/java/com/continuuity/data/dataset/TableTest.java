...
public class TableTest extends DataSetTestBase {
  ...
  public void testSyncWriteReadSwapDelete() throws OperationException {
    ...
    table.exec(new Write(key1, col1, val2));
    ...
    table.exec(new Write(key1, col123, val123));
    ...
    table.exec(new Delete(key1, col1));
    result = table.read(new Read(key1, null, null));
    verifyColumns(result, col23, val23);
  ...
  public void testIncrement() throws OperationException {
    ...
    // increment one value
    table.exec(new Increment(key2, col1, 5L));
    result = table.read(new Read(key2, col1));
    verifyColumn(result, col1, 5L);

    // increment two values
    table.exec(new Increment(key2, col12, new long[] { 2L, 3L } ));
    ...
    table.exec(new Write(key2, col3, val3));
    try {
      table.exec(new Increment(key2, col3, 1L));
  ...
  public void testASyncWriteReadSwapDelete() throws OperationException {
    ...
    table.stage(new Write(key3, col123, val123));
    // increment another column of another row
    table.stage(new Increment(key4, col1, 1L));
    // verify not there
    ...
    table.stage(new Increment(key4, col1, 1L));
    // delete one column
    table.stage(new Delete(key3, col3));
    // swap one of the other columns
    table.stage(new Swap(key3, col1, val1, val2));
    ...
    table.stage(new Delete(key3, col2));
