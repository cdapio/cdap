...
public class ConsumerTest {
	...
	public void testConsumer() throws Exception {
		...
		try { consumer.consumeEvent(badEvent); } catch (Exception e) { }
		...
		try { consumer.consumeEvents(badBatch); } catch (Exception e) { }
		...
		try { consumer.consumeEvents(mixedBatch); } catch (Exception e) { }
