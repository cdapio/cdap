...
public class TAsyncIncrement implements org.apache.thrift.TBase<TAsyncIncrement, TAsyncIncrement._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TAsyncIncrement");
  ...
  static {
    schemes.put(StandardScheme.class, new TAsyncIncrementStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TAsyncIncrementTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TAsyncIncrement.class, metaDataMap);
  }

  public TAsyncIncrement() {
  }
   ...
   */
  public TAsyncIncrement(TAsyncIncrement other) {
...
;
  ...
  public TAsyncIncrement deepCopy() {
    return new TAsyncIncrement(this);
  }
  ...
  public TAsyncIncrement setTable(String table) {
    this.table = table;
    return this;
  }
  ...
  public TAsyncIncrement setMetric(String metric) {
    this.metric = metric;
    return this;
  }
  ...
  public TAsyncIncrement setKey(byte[] key) {
    setKey(key == null ? (ByteBuffer)null : ByteBuffer.wrap(key));
    return this;
  }

  public TAsyncIncrement setKey(ByteBuffer key) {
    this.key = key;
    return this;
  }
  ...
  public TAsyncIncrement setColumns(List<ByteBuffer> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public TAsyncIncrement setAmounts(List<Long> amounts) {
    this.amounts = amounts;
    return this;
  }
  ...
  public TAsyncIncrement setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TAsyncIncrement)
      return this.equals((TAsyncIncrement)that);
    return false;
  }

  public boolean equals(TAsyncIncrement that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TAsyncIncrement other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TAsyncIncrement typedOther = (TAsyncIncrement)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TAsyncIncrement(");
    boolean first = true;
  ...
  private static class TAsyncIncrementStandardSchemeFactory implements SchemeFactory {
    public TAsyncIncrementStandardScheme getScheme() {
      return new TAsyncIncrementStandardScheme();
    }
  }

  private static class TAsyncIncrementStandardScheme extends StandardScheme<TAsyncIncrement> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TAsyncIncrement struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new ArrayList<ByteBuffer>(_list64.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.amounts = new ArrayList<Long>(_list67.size);
                for (int _i68 = 0; _i68 < _list67.size; ++_i68)
                {
                  long _elem69; // required
                  _elem69 = iprot.readI64();
                  struct.amounts.add(_elem69);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAsyncIncrement struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter70 : struct.columns)
          {
      ...
      if (struct.amounts != null) {
        oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
        {
          ...
          for (long _iter71 : struct.amounts)
          {
  ...
  private static class TAsyncIncrementTupleSchemeFactory implements SchemeFactory {
    public TAsyncIncrementTupleScheme getScheme() {
      return new TAsyncIncrementTupleScheme();
    }
  }

  private static class TAsyncIncrementTupleScheme extends TupleScheme<TAsyncIncrement> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TAsyncIncrement struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (ByteBuffer _iter72 : struct.columns)
          {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (long _iter73 : struct.amounts)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TAsyncIncrement struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.columns = new ArrayList<ByteBuffer>(_list74.size);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.amounts = new ArrayList<Long>(_list77.size);
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            long _elem79; // required
            _elem79 = iprot.readI64();
            struct.amounts.add(_elem79);
          }
        }
        struct.setAmountsIsSet(true);
      }
