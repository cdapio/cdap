...
/**
 * {@link com.continuuity.filesystem.Location} is an abstraction provided over the LocalFilesystem location and HDFSFileSystem.
 * As the implementation of {@code Path} and {@code File} are incompatible, this approach allows us
 * to unify both approaches.
 */
public interface LocationFactory {
  /**
   * Creates an instance of {@link com.continuuity.filesystem.Location} based on string <code>path</code>
   *
   * @param path to the resource on the filesystem.
   * @return A instance of {@link com.continuuity.filesystem.Location}
   */
