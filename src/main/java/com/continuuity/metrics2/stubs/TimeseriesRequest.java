...
public class TimeseriesRequest implements org.apache.thrift.TBase<TimeseriesRequest, TimeseriesRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  private MetricTimeseriesLevel level; // required
  private long startts; // required
  private long endts; // required
  private boolean summary; // required
      ...
      switch (field.id) {
        ...
        case 3: // LEVEL
          if (field.type == org.apache.thrift.protocol.TType.I32) {
            this.level = MetricTimeseriesLevel.findByValue(iprot.readI32());
          } else { 
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
          }
          break;
