...
/**
 * Abstract base class for exposing REST read queries via the Gateway.
 */
public abstract class QueryRestProvider {

  protected QueryRestProvider() {}
  
  public abstract void executeQuery(MessageEvent message);
