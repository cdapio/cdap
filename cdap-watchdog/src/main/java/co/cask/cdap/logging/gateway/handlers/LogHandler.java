...
public class LogHandler extends AbstractHttpHandler {
  ...
  private RunRecordMeta getRunRecordMeta(String namespace, String app, ProgramType programType, String programName,
                                         String run) throws NotFoundException {
    ProgramRunId programRunId = new ProgramRunId(namespace, app, programType, programName, run);
    RunRecordMeta runRecord = programStore.getRun(programRunId.getParent().toId(), programRunId.getRun());
    if (runRecord == null) {
