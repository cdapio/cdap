 ...
 */
public class LogAppenderExtensionLoader extends AbstractExtensionLoader<String, Appender> {

  LogAppenderExtensionLoader(String extensionDir) {
    super(extensionDir);
  }

  @Override
  protected Set<String> getSupportedTypesForProvider(Appender appender) {
    return Collections.singleton("stackdriver");
  }
