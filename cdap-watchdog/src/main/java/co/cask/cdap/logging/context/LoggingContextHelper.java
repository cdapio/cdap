...
public final class LoggingContextHelper {
  ...
  public static Filter createFilter(LoggingContext loggingContext) {
    if (loggingContext instanceof ServiceLoggingContext) {
      ...
      // support backward compatibility have an or filter so that we can read old logs too.
  ...
  private static String getNamespaceOrSystemID(Map<String, String> tags) {
    ...
    // compatibility for the logs which are in kafka and needs to be written to HDFS through log saver.
