...
public final class LogCleanup implements Runnable {
  ...
  public void run() {
    ...
    try {
      ...
      cleanupFiles(untilTime, maxMetaFileScanned, namespacedLogBaseDirMap, parentDirs);
  ...
  void cleanFilesWithoutMeta(final long untilTime, final Map<String, NamespaceId> namespacedLogBaseDirMap,
    ...
    LOG.info("Finished deletion of log files older than {} without metadata", untilTime);
  }
