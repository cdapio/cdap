...
/**
 * TwillRunnable to run Search Service through twill.
 */
public class SearchTwillRunnable extends AbstractMasterTwillRunnable {
  private static final Logger LOG = LoggerFactory.getLogger(SearchTwillRunnable.class);
  ...
  public SearchTwillRunnable(String name, String cConfName, String hConfName) {
  ...
  protected void doInit(TwillContext context) {
    try {
      ...
      getCConfiguration().set(Constants.Search.ADDRESS, context.getHost().getCanonicalHostName());
