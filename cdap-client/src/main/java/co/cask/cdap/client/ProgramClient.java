...
public class ProgramClient {
   ...
   * @throws IOException if a network error occurred
   * @throws NotFoundException if the flowlet could not be found
   * @throws UnAuthorizedAccessTokenException if the request is not authorized successfully in the gateway server
   */
  public int getFlowletInstances(String appId, String flowId, String flowletId)
    ...
    Id.Flow.Flowlet flowlet = Id.Flow.Flowlet.from(flow, flowletId);
   ...
   * @throws UnAuthorizedAccessTokenException if the request is not authorized successfully in the gateway server
   */
  public int getWorkerInstances(String appId, String workerId) throws IOException, NotFoundException, UnAuthorizedAccessTokenException {
   ...
   * @throws UnAuthorizedAccessTokenException if the request is not authorized successfully in the gateway server
   */
  public int getServiceInstances(String appId, String serviceId) throws IOException, NotFoundException, UnAuthorizedAccessTokenException {
   ...
   * @throws IOException if a network error occurred
   * @throws NotFoundException if the runnable could not be found
   * @throws UnAuthorizedAccessTokenException if the request is not authorized successfully in the gateway server
   ...
   * @throws IOException if a network error occurred
   * @throws NotFoundException if the service could not be found
   * @throws UnAuthorizedAccessTokenException if the request is not authorized successfully in the gateway server
   */
