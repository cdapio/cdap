...
/**
 * Almost the same as @link{NoMapperApp} Class Except that this one read stream from
 * another namespace "streamSpace"
 */
public class NoMapperStreamSpaceApp extends AbstractApplication {

  public static final String INPUTSTREAMSPACE = "streamSpace";
  ...
  public static final class NoMapperMapReduce extends AbstractMapReduce {
    ...
    public void initialize() throws Exception {
      ...
      context.addInput(Input.ofStream("nomapper").fromNamespace(INPUTSTREAMSPACE));
