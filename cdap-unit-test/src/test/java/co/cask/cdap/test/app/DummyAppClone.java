 ...
 *
 */
public class DummyAppClone extends AbstractApplication {

  @Override
  public void configure() {
    setName("DummyAppClone");
    setDescription("DummyAppClone");
    addStream(new Stream("whoClone"));
    createDataset("whomClone", KeyValueTable.class);
