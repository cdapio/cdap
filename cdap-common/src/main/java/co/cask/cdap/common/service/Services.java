...
public class Services {
  ...
  public static void startAndWait(Service service, long timeout, TimeUnit timeoutUnit,
                                  @Nullable String timeoutErrorMessage) throws Exception {
    ...
    try {
      ...
      LOG.error("Exception while trying to start service.", e);
      throw e;
    }
  }
   ...
   */
  public static void startAndWait(Service service, long timeout, TimeUnit timeoutUnit) throws Exception {
