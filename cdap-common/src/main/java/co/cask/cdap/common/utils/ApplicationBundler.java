 ...
 * This class is copied from Twill to have improvement for the TWILL-112.
 * This class can be removed and reverted back to use the Twill one when TWILL-112 is resolved.
 */
