...
public final class Constants {
  ...
  public static final class Security {
    ...
    /**
     * Whether or not to use token passthrough validation which directly passes the received access token
     * to the authorization extension through Principal.Name.
     */
    public static final String TOKEN_PASSTHROUGH_ENABLED = "security.token.passthrough";
    /**
