 ...
 */
public class CommonProgramClassLoader extends DirectoryClassLoader {
  private static final Logger LOG = LoggerFactory.getLogger(CommonProgramClassLoader.class);
   ...
   * </pre>
   */
  public CommonProgramClassLoader(CConfiguration cConf, File dir, ClassLoader parent) {
