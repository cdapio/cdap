...
/**
 * Standard ruok command handler. Usage example: {@code cmdService =
 * CommandPortService.builder("my-service") .setPort(port) .addCommandHandler(RUOKHandler.COMMAND,
 * RUOKHandler.DESCRIPTION, new RUOKHandler()) .build(); }
 */
