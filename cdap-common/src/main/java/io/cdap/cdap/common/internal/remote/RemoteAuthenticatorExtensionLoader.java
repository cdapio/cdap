...
public class RemoteAuthenticatorExtensionLoader extends
  ...
  @Inject
  RemoteAuthenticatorExtensionLoader(CConfiguration cConf) {
    super(cConf.get(Constants.RemoteAuthenticator.EXTENSIONS_DIR));
  }

  @Override
  protected Set<String> getSupportedTypesForProvider(RemoteAuthenticator remoteAuthenticator) {
    return Collections.singleton(remoteAuthenticator.getName());
  }
