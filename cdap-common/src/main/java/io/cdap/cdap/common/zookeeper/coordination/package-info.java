 ...
 *
 * The {@link io.cdap.cdap.common.zookeeper.coordination.ResourceCoordinator}
 * is expected to have single instance running and is responsible for matching
 * {@link io.cdap.cdap.common.zookeeper.coordination.PartitionReplica} to
 * {@link org.apache.twill.discovery.Discoverable}, based on the specification as described by
 * {@link io.cdap.cdap.common.zookeeper.coordination.ResourceRequirement}. The actual strategy used for
 * the matching is controlled by {@link io.cdap.cdap.common.zookeeper.coordination.AssignmentStrategy}.
 *
 ...
 * {@link io.cdap.cdap.common.zookeeper.coordination.ResourceRequirement}.
 *
 * The coordination service is designed in a way that the interruption of
 * {@link io.cdap.cdap.common.zookeeper.coordination.ResourceCoordinator} availability will only affect
