...
public class HBase10TableUtil extends HBaseTableUtil {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(HBase10TableUtil.class);
  ...
  public HTableDescriptorBuilder buildHTableDescriptor(TableId tableId) {
    Preconditions.checkArgument(tableId != null, "Table id should not be null");
    return new HBase10HTableDescriptorBuilder(HTableNameConverter.toTableName(tablePrefix, tableId));
  }
