...
import io.cdap.cdap.data2.increment.hbase12cdh570.IncrementHandler;
...
import io.cdap.cdap.data2.transaction.messaging.coprocessor.hbase12cdh570.PayloadTableRegionObserver;
...
public class HBase12CDH570TableUtil extends HBaseTableUtil {
  ...
  public HTableDescriptorBuilder buildHTableDescriptor(TableId tableId) {
    ...
    return new HBase12CDH570HTableDescriptorBuilder(
