...
public class DashboardProgramRunRecord {
  ...
  public DashboardProgramRunRecord(ProgramRunId runId, RunRecord runRecord, ArtifactId artifactId,
    ...
    this(runId.getNamespace(), ArtifactSummary.from(artifactId),
        ...
        runRecord.getResumeTs(),
        runRecord.getStopTs(), runRecord.getStatus());
  }

  public DashboardProgramRunRecord(String namespace, ArtifactSummary artifact,
      ApplicationNameVersion application,
  ...
  /**
   * @return the run id of the program run or {@code null} if the program run is scheduled to run in
   *     the future
   */
  @Nullable
  ...
  /**
   * @return the time in seconds when the program run started running, or {@code null} if the
   *     program run has not started running yet.
   */
  @Nullable
  ...
  /**
   * @return the time in seconds when the program was last suspended, or {@code null} if the program
   *     run was not suspended
   */
  @Nullable
  ...
  /**
   * @return the time in seconds when the program was last resumed from suspended state, or {@code
   *     null} if the program run was never suspended or never resumed from suspended state.
   */
  @Nullable
  ...
  /**
   * @return the time in seconds when the program run stopped, or {@code null} if the program run
   *     has not stopped yet.
   */
  @Nullable
  public Long getEnd() {
  ...
  /**
   * @return the status of the program run or {@code null} if the program run is scheduled to run in
   *     the future
   */
  @Nullable
