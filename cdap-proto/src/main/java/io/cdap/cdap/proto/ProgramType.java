...
public enum ProgramType {
  ...
  public static ProgramType valueOfSchedulableType(SchedulableProgramType schedulableType) {
    ...
    throw new IllegalArgumentException(
        "No ProgramType found for SchedulableProgramType " + schedulableType);
  }
  ...
  /**
   * Returns the {@link ProgramType} that represents the given category name, or throw an exception
   * that is generated by the given function.
   *
  ...
  private static final class Parameters {
    ...
    private static final class Builder {
      ...
      Parameters build() {
        return new Parameters(prettyName, listable, categoryName, discoverableTypeName,
            schedulableType,
            apiProgramType);
      }
    }
