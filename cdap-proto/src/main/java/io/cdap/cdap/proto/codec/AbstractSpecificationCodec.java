 ...
 */
public abstract class AbstractSpecificationCodec<T> implements JsonSerializer<T>,
    JsonDeserializer<T> {
  ...
  protected final <V> JsonElement serializeSet(Set<V> set, JsonSerializationContext context,
      Class<V> valueType) {
