...
public interface CredentialProviderContext {
   ...
   * as an entry in the system properties. For example, if the provider is named 'abc', and there
   * is a configuration property 'credential.provider.system.properties.abc.retry.timeout' with
   * value '60', the system properties map will contain a key 'retry.timeout' with value '60'.
   * System properties are not visible to end users and cannot be overwritten by end users.
   *
