...
import io.cdap.cdap.common.artifact.AbstractArtifactClient;
 ...
 */
public class RemoteArtifactClient extends AbstractArtifactClient {

  private static final Logger LOG = LoggerFactory.getLogger(AbstractArtifactClient.class);

  private final RemoteClient remoteClient;

  @Inject
  public RemoteArtifactClient(DiscoveryServiceClient discoveryClient) {
  ...
  protected HttpResponse execute(HttpRequest request, int... allowedErrorCodes) throws IOException,
    ...
    LOG.trace("Making artifact request {}", request.getBody());
