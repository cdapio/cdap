...
/**
 * Interface responsible for managing the lifecycle of a single preview application and retrieving
 * the data generated by that application.
 */
public interface PreviewRunner {

  /**
   * Start the preview of an application. The returned {@link Future} will be completed when the
   * preview completed.
   *
