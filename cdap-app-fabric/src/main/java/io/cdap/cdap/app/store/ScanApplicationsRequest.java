...
public class ScanApplicationsRequest {
  ...
  /**
   *
   * @return boolean whether to return only the latest version of the app
   */
  ...
  public static class Builder {
    ...
    /**
     *
     * @param latestOnly boolean whether to return only the latest version of the app
     */
