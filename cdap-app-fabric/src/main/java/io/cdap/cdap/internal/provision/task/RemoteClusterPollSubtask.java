 ...
 */
public class RemoteClusterPollSubtask extends ProvisioningSubtask {
  private static final Logger LOG = LoggerFactory.getLogger(RemoteClusterPollSubtask.class);

  public RemoteClusterPollSubtask(Provisioner provisioner, ProvisionerContext provisionerContext,
