...
public interface OperationRunner<T> {
   ...
   * @throws OperationTypeNotSupportedException if the operation type in the request is not
   *     supported
   * @throws InvalidRequestTypeException if the request object T is not valid for the operation
   *     type
   */
   ...
   * @return A {@link ListenableFuture} that will be completed when the operation is actually
   *     stopped.
   **/
