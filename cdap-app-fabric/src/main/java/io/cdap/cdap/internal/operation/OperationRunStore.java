...
public class OperationRunStore {
   ...
   */
  public void updateOperationMeta(
      OperationRunId runId, OperationMeta metadata, @Nullable byte[] sourceId)
    ...
    OperationRun updatedRun = OperationRun.builder(currentRun).setMetadata(metadata).build();
   ...
   * @throws OperationRunNotFoundException run with id does not exist in namespace
   */
  public void failOperationRun(
      OperationRunId runId, OperationError error, @Nullable byte[] sourceId)
      throws OperationRunNotFoundException, IOException {
    OperationRunDetail currentDetail = getRunDetail(runId);
    OperationRun currentRun = currentDetail.getRun();
    OperationRun updatedRun =
