 ...
 *
 */
public class SourceControlOperationFactoryProvider implements Provider<SourceControlOperationRunnerFactory> {
  private final CConfiguration cConf;
  private final Injector injector;

  @Inject
  SourceControlOperationFactoryProvider(CConfiguration cConf, Injector injector) {
    this.cConf = cConf;
