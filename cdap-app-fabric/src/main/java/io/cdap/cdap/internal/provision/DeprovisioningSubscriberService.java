 ...
 */
public class DeprovisioningSubscriberService extends ProvisionBaseSubscriberService {

  @Inject
  DeprovisioningSubscriberService(MessagingService messagingService, CConfiguration cConf,
    ...
    super("deprovision", cConf.get(Constants.AppFabric.DEPROVISION_EVENT_TOPIC),
          cConf.getInt(Constants.AppFabric.DEPROVISION_EVENT_FETCH_SIZE),
          cConf.getLong(Constants.AppFabric.DEPROVISION_EVENT_POLL_DELAY_MILLIS),
