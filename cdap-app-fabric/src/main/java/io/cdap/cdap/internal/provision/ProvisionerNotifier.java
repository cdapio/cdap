...
public class ProvisionerNotifier {
  ...
  private final TopicId programStartTopic;
  ...
  ProvisionerNotifier(CConfiguration cConf, MessagingService messagingService) {
    this.programStartTopic =
      NamespaceId.SYSTEM.topic(cConf.get(Constants.AppFabric.PROGRAM_START_EVENT_TOPIC));
  ...
  public void enqueue(ProgramRunId programRunId, ProgramOptions programOptions,
    ...
    publish(programStartTopic, ImmutableMap.<String, String>builder()
