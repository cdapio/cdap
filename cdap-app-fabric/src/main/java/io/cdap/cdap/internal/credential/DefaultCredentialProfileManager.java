 ...
 */
public class DefaultCredentialProfileManager implements CredentialProfileManager {
  ...
  @Inject
  DefaultCredentialProfileManager(CredentialIdentityStore identityStore,
  ...
  @Override
  public Optional<CredentialProfile> get(CredentialProfileId id)
