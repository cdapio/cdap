 ...
 */
public class ArtifactLocalizer extends ArtifactLocalizerBase {
  ...
  @Override
  public HttpURLConnection openConnection(ArtifactId artifactId, @Nullable String unused) throws IOException {
