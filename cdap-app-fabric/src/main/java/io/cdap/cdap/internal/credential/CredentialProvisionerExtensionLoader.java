...
import io.cdap.cdap.security.spi.credential.CredentialProvisioner;
import java.io.IOException;
import java.util.Collections;
import java.util.Set;

/**
 * Extension loader for {@link CredentialProvisioner}.
 */
public class CredentialProvisionerExtensionLoader extends AbstractExtensionLoader<String,
  ...
  @Inject
  CredentialProvisionerExtensionLoader(CConfiguration cConf) {
    super(cConf.get(Constants.CredentialProvisioner.EXTENSIONS_DIR));
  }

  @Override
  protected Set<String> getSupportedTypesForProvider(CredentialProvisioner credentialProvisioner) {
    return Collections.singleton(credentialProvisioner.getName());
  }
