...
public class RemoteApplicationLifeCycleClient {
  private static final Gson GSON = ApplicationSpecificationAdapter.addTypeAdapters(new GsonBuilder()).create();

  private final RemoteClient remoteClient;

  public RemoteApplicationLifeCycleClient(final DiscoveryServiceClient discoveryClient) {
   ...
   */
  public ApplicationDetail getApplication(ApplicationId appId) throws IOException, NotFoundException {
   ...
   */
  public List<ApplicationDetail> getAllApplications(String namespace) throws IOException, NotFoundException {
    ...
    try {
      ...
      throw new NotFoundException(NamespaceId.fromString(namespace));
    }
