...
public class RemotePreferencesInternalClient {
  private static final Gson GSON = new Gson();

  private final RemoteClient remoteClient;

  public RemotePreferencesInternalClient(final DiscoveryServiceClient discoveryClient) {
   ...
   */
  public PreferencesDetail getPreferences(EntityId entityId, boolean resolved) throws IOException, NotFoundException {
    ...
    return GSON.fromJson(httpResponse.getResponseBodyAsString(), new TypeToken<PreferencesDetail>() { }.getType());
  }
