 ...
 * {@link io.cdap.cdap.security.spi.authentication.SecurityRequestContext}.
 */
public class ContextInheritingScheduledThreadPoolExecutor implements ScheduledExecutorService {
  ...
  public ScheduledFuture<?> schedule(Runnable command, long delay, TimeUnit unit) {
    return delegate.schedule(SecurityContextRunnables.wrapRunnableWithContext(command), delay, unit);
  }

  @Override
  public <V> ScheduledFuture<V> schedule(Callable<V> callable, long delay, TimeUnit unit) {
    return delegate.schedule(SecurityContextRunnables.wrapCallableWithContext(callable), delay, unit);
  }

  @Override
  public ScheduledFuture<?> scheduleAtFixedRate(Runnable command, long initialDelay, long period, TimeUnit unit) {
    return delegate.scheduleAtFixedRate(SecurityContextRunnables.wrapRunnableWithContext(command), initialDelay,
                                        period, unit);
  }

  @Override
  public ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, long initialDelay, long delay, TimeUnit unit) {
    return delegate.scheduleWithFixedDelay(SecurityContextRunnables.wrapRunnableWithContext(command), initialDelay,
                                           delay, unit);
  }
}
