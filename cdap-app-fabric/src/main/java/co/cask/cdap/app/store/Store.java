...
public interface Store {
  ...
  /**
   * Get the Twill RunId to CDAP RunId mappings.
   * @return the mapping
   */
  Map<String, String> getRunIdMappings();

  /**
   * Add a new Twill to CDAP RunId mapping.
   * @param twillRunId The RunId generated by the Twill
   * @param runId      The RunId generated by the CDAP
   */
  void addRunIdMapping(String twillRunId, String runId);

  /**
   * Remove the entry for Twill RunId from Twill to CDAP RunId mapping.
   * @param twillRunId The RunId generated by the Twill
   */
  void removeRunIdMapping(String twillRunId);
}
