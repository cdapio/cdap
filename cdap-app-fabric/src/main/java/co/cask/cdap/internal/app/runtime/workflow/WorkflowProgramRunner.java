...
public class WorkflowProgramRunner extends AbstractProgramRunnerWithPlugin {
  ...
  public ProgramController run(final Program program, final ProgramOptions options) {
    ...
    try {
      ...
      WorkflowDriver driver = new WorkflowDriver(program, options, hostname, workflowSpec, workflowToken,
                                                 programRunnerFactory, metricsCollectionService, datasetFramework,
                                                 discoveryServiceClient, txClient, runtimeStore, cConf,
