...
public class ClusterInfo {
  ...
  public ClusterInfo(ClusterInfo existing, ClusterOp op, @Nullable SSHKeyInfo sshKeyInfo, @Nullable Cluster cluster) {
    this(existing.getProgramRunId(), existing.getProgramDescriptor(), existing.getProvisionerProperties(),
         existing.getProvisionerName(), existing.getUser(), op, sshKeyInfo, cluster);
  }
