 ...
 * and free of any library dependencies. The {@link #launch(String, String, String, String, String[])}} method is
...
public class MapReduceContainerLauncher {
   ...
   *
   * 1. Creates the MainClassLoader for dataset rewrite from the given classPath, with the context classloader
   *    parent as its own parent.
