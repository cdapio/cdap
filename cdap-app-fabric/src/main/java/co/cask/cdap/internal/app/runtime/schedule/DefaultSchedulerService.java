...
public class DefaultSchedulerService {
  ...
  static final class ScheduledJob implements Job {
    ...
    ScheduledJob(Store store, ProgramRuntimeService programRuntimeService, PreferencesWrapper preferencesWrapper) {
      taskRunner = new ScheduleTaskRunner(store, programRuntimeService, preferencesWrapper);
    }
