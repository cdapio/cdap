 ...
 * the License.
 *
 * This class is copied from Hadoop 2.3.0. Original license:
 *
...
/** 
 * Copy of the Hadoop Shell class with fix for HADOOP-10622.
...
abstract public class Shell {
  ...
  private void runCommand() throws IOException { 
    ...
    try {
      ...
      //----- start change CDAP-14076 -----
      // make sure that the error thread exits
      joinThread(errThread);
      //----- end change CDAP-14076 -----
      completed.set(true);
