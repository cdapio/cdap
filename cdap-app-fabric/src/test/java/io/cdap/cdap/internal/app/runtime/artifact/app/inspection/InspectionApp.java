...
public class InspectionApp extends AbstractApplication<InspectionApp.AConfig> {
  ...
  public static class BConfig extends PluginConfig {
    private String isSomething;
  }

  public static class NestedConfig extends BConfig {
    private String str;
    private POJO pojo;
  }
  ...
  public static class NestedPlugin {
    private NestedConfig pluginConf;

    public String getstr1() {
      return pluginConf.pojo.str1;
    }
  }
