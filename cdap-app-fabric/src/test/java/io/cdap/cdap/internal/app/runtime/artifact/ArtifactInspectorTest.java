...
//             new EntityImpersonator(artifactId.toEntityId(), new DefaultImpersonator(CConfiguration.create(),
//             null)))) {
...
//    Assert.assertEquals(new Requirements(ImmutableSet.of(Table.TYPE, "sometype"), ImmutableSet.of("cdc",
//    "healthcare")),
