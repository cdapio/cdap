...
public class CapabilitySleepingWorkflowApp extends AbstractApplication {

  public static final String NAME = "CapabilitySleepingWorkflowApp";
  public static final String DESC = "CapabilitySleepingWorkflowApp";
