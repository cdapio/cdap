...
public class SupportBundleHttpHandlerTest extends AppFabricTestBase {
  ...
  @Test
  public void testCreateSupportBundleWithMaxRunSpecified() throws Exception {
    createNamespace("default");
    String path =
  ...
  private void testLogsRunId() throws Exception {
    ...
    if (bodyResponse.startsWith("Support Bundle")) {
      ...
      HttpResponse supportBundleGetFilesResponse = doGet(
        String.format("/%s/%s", Constants.Gateway.API_VERSION_3_TOKEN, supportBundleGetUrl));
