...
public class DefaultStoreTest {
  ...
  public void testAdapterMDSOperations() throws Exception {
    ...
    AdapterSpecification spec1 = AdapterSpecification.builder("spec1", "template1", ProgramType.WORKFLOW, "program1")
    ...
    AdapterSpecification spec2 = AdapterSpecification.builder("spec2", "template2", ProgramType.WORKER, "program2")
