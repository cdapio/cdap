...
public class ArtifactStoreTest {
    ...
    public void testGetNonexistantArtifact() throws IOException {
        ...
        ArtifactRange range = new ArtifactRange(namespace.getNamespace(), "something", new ArtifactVersion("1.0.0"),
        ...
        // no artifact by namespace, artifact name, and version should throw an
        // exception
        try {
    ...
    public void testAddGetSingleArtifact() throws Exception {
        ...
        PluginClass plugin2 = new PluginClass("atype", "plugin2", "", null, null, null, "c.c.c.plugin2", "cfg",
                ImmutableMap.<String, PluginPropertyField>of());
        PluginClass plugin3 = new PluginClass("btype", "plugin3", "", null, null, null, "c.c.c.plugin3", "cfg",
                ImmutableMap.<String, PluginPropertyField>of());

        Set<PluginClass> plugins = ImmutableSet.of(plugin1, plugin2, plugin3);
        ApplicationClass appClass = new ApplicationClass(InspectionApp.class.getName(), "",
                new ReflectionSchemaGenerator().generate(InspectionApp.AConfig.class));
        ArtifactMeta artifactMeta = new ArtifactMeta(
                ArtifactClasses.builder().addPlugins(plugins).addApp(appClass).build());
        ...
        // test that plugins in the artifact show up when getting plugins for that
        // artifact
        Map<ArtifactDescriptor, Set<PluginClass>> pluginsMap = artifactStore.getPluginClasses(NamespaceId.DEFAULT,
                artifactId);
        ...
        Map<ArtifactDescriptor, PluginClass> pluginClasses = artifactStore.getPluginClasses(
                NamespaceId.DEFAULT.getNamespaceId(), artifactId, "btype", "plugin3", null, Integer.MAX_VALUE,
    ...
    public void testDelete() throws Exception {
        ...
        List<PluginClass> plugins = ImmutableList.of(
                new PluginClass("atype", "plugin1", "", null, null, null, "c.c.c.plugin1", "cfg",
                        ImmutableMap.<String, PluginPropertyField>of()),
                new PluginClass("atype", "plugin2", "", null, null, null, "c.c.c.plugin2", "cfg",
                        ImmutableMap.<String, PluginPropertyField>of()));
        Set<ArtifactRange> parents = ImmutableSet.of(new ArtifactRange(parentId.getNamespace().getId(),
                parentId.getName(), new ArtifactVersion("0.1.0"), new ArtifactVersion("2.0.0")));
    ...
    public void testSnapshotMutability() throws Exception {
        ...
        ArtifactMeta artifactMeta = new ArtifactMeta(ArtifactClasses.builder().addPlugins(plugin1, plugin2).build(),
                ImmutableSet.of(parentArtifacts));
        writeArtifact(artifactId, artifactMeta, "abc123");

        // update meta and jar contents
        artifactMeta = new ArtifactMeta(ArtifactClasses.builder().addPlugin(plugin2).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        Assert.assertEquals(ImmutableMap.of(detail.getDescriptor(), plugin2),
                artifactStore.getPluginClasses(NamespaceId.DEFAULT, parentArtifactId, plugin2.getType(),
                        plugin2.getName(), null, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED));
        try {
    ...
    public void testPluginNamespaceIsolation() throws Exception {
        ...
        Set<ArtifactRange> usableBy = ImmutableSet
                .of(new ArtifactRange(systemAppArtifact.getNamespace().getId(), systemAppArtifact.getName(),
                        systemAppArtifact.getVersion(), true, systemAppArtifact.getVersion(), true));

        PluginClass plugin = new PluginClass("atype", "plugin1", "", null, null, null, "c.c.c.plugin1", "cfg",
                ImmutableMap.<String, PluginPropertyField>of());
        ...
        try {
            ...
            SortedMap<ArtifactDescriptor, Set<PluginClass>> plugins = artifactStore.getPluginClasses(namespace1,
                    systemAppArtifact);
    ...
    public void testGetArtifacts() throws Exception {
        ...
        PluginClass plugin1V1 = new PluginClass("atype", "plugin1", "", null, null, null, "c.c.c.plugin1", "cfg",
                ImmutableMap.<String, PluginPropertyField>of());
        ...
        PluginClass plugin2V1 = new PluginClass("atype", "plugin2", "", null, null, null, "c.c.c.plugin2", "cfg",
                ImmutableMap.<String, PluginPropertyField>of());
        PluginClass plugin2V2 = new PluginClass("atype", "plugin2", "", null, null, null, "c.c.c.plugin2", "cfg",
                ImmutableMap.<String, PluginPropertyField>of());
        PluginClass plugin2V3 = new PluginClass("atype", "plugin2", "", null, null, null, "c.c.c.plugin2", "cfg",
                ImmutableMap.<String, PluginPropertyField>of());
        ...
        List<ArtifactDetail> artifact1Versions = artifactStore.getArtifacts(artifact1V1.getNamespace().toEntityId(),
                artifact1V1.getName(), Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED);
        Assert.assertEquals(1, artifact1Versions.size());
        assertEqual(artifact1V1, meta1V1, contents1V1, artifact1Versions.get(0));

        List<ArtifactDetail> artifact2Versions = artifactStore.getArtifacts(artifact2V1.getNamespace().toEntityId(),
                artifact2V1.getName(), Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED);
        ...
        ArtifactRange range = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "artifact2",
                new ArtifactVersion("0.1.0"), new ArtifactVersion("0.1.2"));
        ...
        range = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "artifact2", new ArtifactVersion("0.1.1"),
                new ArtifactVersion("1.0.0"));
        artifactVersions = artifactStore.getArtifacts(range, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED);
        Assert.assertEquals(1, artifactVersions.size());
        assertEqual(artifact2V2, meta2V2, contents2V2, artifactVersions.get(0));
        // this range should get just v0.1.0 and v0.1.1-SNAPSHOT
        range = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "artifact2", new ArtifactVersion("0.0.0"),
                new ArtifactVersion("0.1.1"));
        artifactVersions = artifactStore.getArtifacts(range, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED);
    ...
    public void testGetAppClasses() throws Exception {
        ...
        ApplicationClass inspectionClass1 = new ApplicationClass(InspectionApp.class.getName(), "v1",
                new ReflectionSchemaGenerator().generate(InspectionApp.AConfig.class));
        ...
        ApplicationClass inspectionClass2 = new ApplicationClass(InspectionApp.class.getName(), "v2",
                new ReflectionSchemaGenerator().generate(InspectionApp.AConfig.class));
        ...
        ApplicationClass wordCountClass1 = new ApplicationClass(WordCountApp.class.getName(), "v1",
                new ReflectionSchemaGenerator().generate(InspectionApp.AConfig.class));
        ...
        Map<ArtifactDescriptor, List<ApplicationClass>> appClasses = artifactStore
                .getApplicationClasses(NamespaceId.DEFAULT);
        Map<ArtifactDescriptor, List<ApplicationClass>> expected = ImmutableMap
                .<ArtifactDescriptor, List<ApplicationClass>>of(app1v1Detail.getDescriptor(),
                        ImmutableList.of(inspectionClass1), app1v2Detail.getDescriptor(),
                        ImmutableList.of(inspectionClass2), app2v1Detail.getDescriptor(),
                        ImmutableList.of(inspectionClass1), app3v1Detail.getDescriptor(),
                        ImmutableList.of(wordCountClass1));
        Assert.assertEquals(expected, appClasses);

        // test getting all app classes by class name
        Map<ArtifactDescriptor, ApplicationClass> appArtifacts = artifactStore
                .getApplicationClasses(NamespaceId.DEFAULT, InspectionApp.class.getName());
        Map<ArtifactDescriptor, ApplicationClass> expectedAppArtifacts = ImmutableMap.of(app1v1Detail.getDescriptor(),
                inspectionClass1, app1v2Detail.getDescriptor(), inspectionClass2, app2v1Detail.getDescriptor(),
                inspectionClass1);
    ...
    public void testExcludedPlugins() throws Exception {
        ...
        PluginClass includedPlugin1 = new PluginClass("A", "includedPlugin1", "desc", null, null, null, "c.p2", "conf",
                ImmutableMap.of("stream", new PluginPropertyField("stream", "description", "string", true, false)));

        PluginClass excludedPlugin1 = new PluginClass("A", "excludedPlugin1", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)),
                new HashSet<>(), new Requirements(ImmutableSet.of(Table.TYPE)));

        PluginClass excludedPlugin2 = new PluginClass("A", "excludedPlugin2", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)),
                new HashSet<>(), new Requirements(ImmutableSet.of(KeyValueTable.TYPE)));

        PluginClass excludedPlugin3 = new PluginClass("A", "excludedPlugin3", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)),
                new HashSet<>(), new Requirements(ImmutableSet.of(Table.TYPE, KeyValueTable.TYPE)));

        PluginClass excludedPlugin4 = new PluginClass("A", "excludedPlugin4", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)),
                new HashSet<>(), new Requirements(ImmutableSet.of(Table.TYPE, KeyValueTable.TYPE, Cube.TYPE)));

        PluginClass excludedPlugin5 = new PluginClass("A", "excludedPlugin5", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)),
                new HashSet<>(), new Requirements(ImmutableSet.of(Table.TYPE, Cube.TYPE)));

        PluginClass includedPlugin2 = new PluginClass("A", "includedPlugin2", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)),
                new HashSet<>(), new Requirements(ImmutableSet.of("noTransactionNeeded")));

        PluginClass includedPlugin3 = new PluginClass("A", "includedPlugin3", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)),
        ...
        ArtifactMeta artifactMeta = new ArtifactMeta(
                ArtifactClasses.builder()
                        .addPlugins(includedPlugin1, includedPlugin2, includedPlugin3, excludedPlugin1, excludedPlugin2,
                                excludedPlugin3, excludedPlugin4, excludedPlugin5)
                        .build(),
                ImmutableSet.of(parentArtifacts));
        ...
        // plugins which have transaction or spark as requirement should be excluded
        // from plugins listed for the artifact
        Map<ArtifactDescriptor, Set<PluginClass>> actual = artifactStore.getPluginClasses(NamespaceId.DEFAULT,
                artifactId);
    ...
    public void testGetPlugins() throws Exception {
        ...
        PluginClass pluginA1 = new PluginClass("A", "p1", "desc", null, null, null, "c.p1", "cfg",
                ImmutableMap.of("threshold", new PluginPropertyField("thresh", "description", "double", true, false),
                        "retry", new PluginPropertyField("retries", "description", "int", false, false)));
        PluginClass pluginA2 = new PluginClass("A", "p2", "desc", null, null, null, "c.p2", "conf",
                ImmutableMap.of("stream", new PluginPropertyField("stream", "description", "string", true, false)));
        PluginClass pluginB1 = new PluginClass("B", "p1", "desc", null, null, null, "c.p1", "cfg", ImmutableMap
                .of("createIfNotExist", new PluginPropertyField("createIfNotExist", "desc", "boolean", false, false)));
        PluginClass pluginB2 = new PluginClass("B", "p2", "desc", null, null, null, "c.p2", "stuff",
                ImmutableMap.of("numer", new PluginPropertyField("numerator", "description", "double", true, false),
        ...
        ArtifactMeta metaXv100 = new ArtifactMeta(ArtifactClasses.builder().addPlugin(pluginA1).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        ArtifactMeta metaXv110 = new ArtifactMeta(ArtifactClasses.builder().addPlugin(pluginA1).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        ArtifactMeta metaXv200 = new ArtifactMeta(ArtifactClasses.builder().addPlugins(pluginA1, pluginA2).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        ArtifactMeta metaYv100 = new ArtifactMeta(ArtifactClasses.builder().addPlugin(pluginB1).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        ArtifactMeta metaYv200 = new ArtifactMeta(ArtifactClasses.builder().addPlugin(pluginB2).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        ArtifactMeta metaZv100 = new ArtifactMeta(ArtifactClasses.builder().addPlugins(pluginA1, pluginB1).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        Map<ArtifactDescriptor, PluginClass> actualMap = artifactStore.getPluginClasses(NamespaceId.DEFAULT,
                parentArtifactId, "A", "p1", null, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED);
        ...
        Predicate<ArtifactId> predicate = input -> {
            try {
                return input.getParent().equals(NamespaceId.DEFAULT) && input.getArtifact().equals("artifactX")
                        && ArtifactVersionRange.parse("[1.0.0, 1.1.0)")
        ...
        actualMap = artifactStore.getPluginClasses(NamespaceId.DEFAULT, parentArtifactId, "A", "p1", predicate, 1,
                ArtifactSortOrder.DESC);
        Assert.assertEquals(ImmutableMap.of(artifactXv100Info, pluginA1), actualMap);
    ...
    public void testGetPluginsByParentArtifactRanges() throws Exception {
        ArtifactRange parentArtifacts1 = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent1",
                new ArtifactVersion("1.0.0"), new ArtifactVersion("5.0.0"));
        ...
        Id.Artifact artifactXv100 = Id.Artifact.from(Id.Namespace.DEFAULT, "artifactX", "1.0.0");
        ArtifactMeta metaXv100 = new ArtifactMeta(ArtifactClasses.builder().addPlugin(pluginA1).build(),
                ImmutableSet.of(parentArtifacts1));
        writeArtifact(artifactXv100, metaXv100, contents);
        ArtifactDescriptor artifactXv100Info = artifactStore.getArtifact(artifactXv100).getDescriptor();
        ...
        ArtifactRange parentArtifactsrange1 = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent1",
                new ArtifactVersion("3.0.0"), new ArtifactVersion("5.0.0"));

        // artifact artifactZ-2.0.0 contains plugins A1, A2
        Id.Artifact artifactZv200 = Id.Artifact.from(Id.Namespace.DEFAULT, "artifactZ", "2.0.0");
        ArtifactMeta metaZv200 = new ArtifactMeta(ArtifactClasses.builder().addPlugins(pluginA1, pluginA2).build(),
                ImmutableSet.of(parentArtifactsrange1));
        writeArtifact(artifactZv200, metaZv200, contents);
        ArtifactDescriptor artifactZv200Info = artifactStore.getArtifact(artifactZv200).getDescriptor();

        // artifact written with this range should not come up as their parent range is
        // out of the parent artifact range.
        ArtifactRange parentArtifactsOutOfRange1 = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent1",
                new ArtifactVersion("5.0.0"), new ArtifactVersion("8.0.0"));

        // artifact artifactZ-2.0.0 contains plugins A1, A2, B1, and B2
        Id.Artifact artifactZv300 = Id.Artifact.from(Id.Namespace.DEFAULT, "artifactZ", "3.0.0");
        ArtifactMeta metaZv300 = new ArtifactMeta(ArtifactClasses.builder().addPlugins(pluginA1, pluginA2).build(),
        ...
        expectedMap.put(artifactXv200Info, pluginA1);
        expectedMap.put(artifactZv200Info, pluginA1);
        Assert.assertEquals(expectedMap, artifactStore.getPluginClasses(NamespaceId.DEFAULT, parentArtifacts1, "A",
                "p1", null, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED));
        // test limited number
        Assert.assertEquals(ImmutableMap.of(artifactXv100Info, pluginA1), artifactStore.getPluginClasses(
                NamespaceId.DEFAULT, parentArtifacts1, "A", "p1", null, 1, ArtifactSortOrder.UNORDERED));
        // test DESC order
        Assert.assertEquals(expectedMap, new TreeMap<>(artifactStore.getPluginClasses(NamespaceId.DEFAULT,
                parentArtifacts1, "A", "p1", null, Integer.MAX_VALUE, ArtifactSortOrder.DESC)).descendingMap());

        ArtifactRange parentArtifactsSub1 = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent1",
                new ArtifactVersion("1.1.0"), new ArtifactVersion("2.0.0"));
        expectedMap = Maps.newHashMap();
        expectedMap.put(artifactXv100Info, pluginA1);
        expectedMap.put(artifactXv110Info, pluginA1);
        expectedMap.put(artifactXv200Info, pluginA1);

        // artifactZv200Info wont be here, as the parent range 3.0.0-5.0.0 for
        // artifactZv200 plugin
        // wont match the 1.2.1 parent artifact version
        Assert.assertEquals(expectedMap, artifactStore.getPluginClasses(NamespaceId.DEFAULT, parentArtifactsSub1, "A",
                "p1", null, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED));
        expectedMap = Maps.newHashMap();
        expectedMap.put(artifactXv200Info, pluginA2);
        expectedMap.put(artifactZv200Info, pluginA2);
        Assert.assertEquals(expectedMap, artifactStore.getPluginClasses(NamespaceId.DEFAULT, parentArtifacts1, "A",
                "p2", null, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED));

        ArtifactRange parentArtifactsSub2 = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent1",
                new ArtifactVersion("5.0.0"), new ArtifactVersion("10.0.0"));
        try {
    ...
    public void testSamePluginDifferentArtifacts() throws Exception {
        ...
        Set<PluginClass> plugins = ImmutableSet.of(
                ...
                new PluginClass("atype", "plugin2", "", null, null, null, "c.c.c.plugin2", "cfg",
                        ImmutableMap.<String, PluginPropertyField>of()));
        ArtifactMeta meta1 = new ArtifactMeta(ArtifactClasses.builder().addPlugins(plugins).build(),
                ImmutableSet.of(parentArtifacts));
        ...
        ArtifactMeta meta2 = new ArtifactMeta(ArtifactClasses.builder().addPlugins(plugins).build(),
                ImmutableSet.of(parentArtifacts));
    ...
    public void testPluginParentInclusiveExclusiveVersions() throws Exception {
        ...
        Set<ArtifactRange> parentArtifacts = ImmutableSet.of(new ArtifactRange(NamespaceId.DEFAULT.getNamespace(),
                "parent", new ArtifactVersion("1.0.0"), true, new ArtifactVersion("1.0.0"), true));
        List<PluginClass> plugins = ImmutableList.of(new PluginClass("typeA", "plugin1", "", null, null, null,
                "c.c.c.plugin1", "cfg", ImmutableMap.<String, PluginPropertyField>of()));
        ...
        parentArtifacts = ImmutableSet.of(new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent",
                new ArtifactVersion("2.0.0"), true, new ArtifactVersion("2.0.1"), false));
        plugins = ImmutableList.of(new PluginClass("typeA", "plugin2", "", null, null, null, "c.c.c.plugin2", "cfg",
                ImmutableMap.<String, PluginPropertyField>of()));
        ...
        parentArtifacts = ImmutableSet.of(new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent",
                new ArtifactVersion("3.0.0"), false, new ArtifactVersion("3.0.1"), true));
        plugins = ImmutableList.of(new PluginClass("typeA", "plugin3", "", null, null, null, "c.c.c.plugin3", "cfg",
                ImmutableMap.<String, PluginPropertyField>of()));
        meta = new ArtifactMeta(ArtifactClasses.builder().addPlugins(plugins).build(), parentArtifacts);
        ...
        parentArtifacts = ImmutableSet.of(new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent",
                new ArtifactVersion("4.0.0"), false, new ArtifactVersion("4.0.2"), false));
        plugins = ImmutableList.of(new PluginClass("typeA", "plugin4", "", null, null, null, "c.c.c.plugin4", "cfg",
                ImmutableMap.<String, PluginPropertyField>of()));
        meta = new ArtifactMeta(ArtifactClasses.builder().addPlugins(plugins).build(), parentArtifacts);
    ...
    // this test tests that when an artifact specifies a range of artifact versions
    // it extends,
    ...
    public void testPluginParentVersions() throws Exception {
        ...
        Set<ArtifactRange> parentArtifacts = ImmutableSet.of(new ArtifactRange(NamespaceId.DEFAULT.getNamespace(),
                "parent", new ArtifactVersion("1.0.0"), new ArtifactVersion("2.0.0")));
        Set<PluginClass> plugins = ImmutableSet.of(new PluginClass("atype", "plugin1", "", null, null, null,
                "c.c.c.plugin1", "cfg", ImmutableMap.<String, PluginPropertyField>of()));
        ArtifactMeta meta = new ArtifactMeta(ArtifactClasses.builder().addPlugins(plugins).build(), parentArtifacts);
        ...
        for (Id.Artifact badId : badIds) {
            // write the parent artifact to make sure we don't get ArtifactNotFound
            // exceptions with later calls
        ...
        Map<ArtifactDescriptor, PluginClass> expectedPluginsMap = ImmutableMap.of(artifactInfo,
        ...
        for (Id.Artifact goodId : goodIds) {
            ...
            Assert.assertEquals(expectedPluginsMap, artifactStore.getPluginClasses(NamespaceId.DEFAULT, goodId, "atype",
                    "plugin1", null, Integer.MAX_VALUE, ArtifactSortOrder.UNORDERED));
        }
    }
    ...
    public void testConcurrentWrite() throws Exception {
        // start up a bunch of threads that will try and write the same artifact at the
        // same time
        ...
        for (int i = 0; i < numThreads; i++) {
            ...
            executorService.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        barrier.await();
                        ArtifactMeta meta = new ArtifactMeta(ArtifactClasses
                                .builder().addPlugin(new PluginClass("plugin-type", "plugin" + writer, "", null, null,
                                        null, "classname", "cfg", ImmutableMap.<String, PluginPropertyField>of()))
                                .build());
        ...
        ArtifactMeta expectedMeta = new ArtifactMeta(
                ArtifactClasses.builder().addPlugin(new PluginClass("plugin-type", "plugin" + successfulWriter, "",
                        null, null, null, "classname", "cfg", ImmutableMap.<String, PluginPropertyField>of())).build());
    ...
    public void testUpdateProperties() throws Exception {
        ...
        ArtifactMeta meta = new ArtifactMeta(ArtifactClasses.builder().build(), ImmutableSet.<ArtifactRange>of(),
                properties);
        writeArtifact(artifactId, meta, "some contents");
    ...
    public void testConcurrentSnapshotWrite() throws Exception {
        ...
        final ArtifactRange parentArtifacts = new ArtifactRange(NamespaceId.DEFAULT.getNamespace(), "parent",
                new ArtifactVersion("1.0.0"), new ArtifactVersion("2.0.0"));
        // start up a bunch of threads that will try and write the same artifact at the
        // same time
        // only one of them should be able to write it
        ...
        for (int i = 0; i < numThreads; i++) {
            ...
            executorService.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        barrier.await();
                        ArtifactMeta meta = new ArtifactMeta(ArtifactClasses.builder()
                                .addPlugin(new PluginClass("plugin-type", "plugin" + writer, "", null, null, null,
                                        "classname", "cfg", ImmutableMap.<String, PluginPropertyField>of()))
                                .build(), ImmutableSet.of(parentArtifacts));
                        writeArtifact(artifactId, meta, writer);
                    } catch (InterruptedException | BrokenBarrierException | ArtifactAlreadyExistsException
                            | IOException e) {
                        // something went wrong, fail the test
                        throw new RuntimeException(e);
                    } catch (WriteConflictException e) {
                        // these are ok though unexpected (means couldn't write after a bunch of retries
                        // too)
                    } finally {
                        latch.countDown();
                    }
        ...
        // figure out which was the last writer by reading our data. all the writers
        ...
        ArtifactMeta expectedMeta = new ArtifactMeta(
                ArtifactClasses.builder()
                        .addPlugin(new PluginClass("plugin-type", "plugin" + winnerWriter, "", null, null, null,
                                "classname", "cfg", ImmutableMap.<String, PluginPropertyField>of()))
                        .build(),
                ImmutableSet.of(parentArtifacts));
        ...
        Map<ArtifactDescriptor, Set<PluginClass>> pluginMap = artifactStore.getPluginClasses(NamespaceId.DEFAULT,
                parentArtifactId, "plugin-type");
        Map<ArtifactDescriptor, Set<PluginClass>> expected = Maps.newHashMap();
        expected.put(detail.getDescriptor(),
                ImmutableSet.<PluginClass>of(new PluginClass("plugin-type", "plugin" + winnerWriter, "", null, null,
                        null, "classname", "cfg", ImmutableMap.<String, PluginPropertyField>of())));
    ...
    public void testUniversalPlugin() throws Exception {
        // First, deploy an artifact in the SYSTEM scope that doesn't have any plugin
        // inside.
        ArtifactId artifactId = NamespaceId.SYSTEM.artifact("artifact", "1.0.0");
        writeArtifact(Id.Artifact.fromEntityId(artifactId), new ArtifactMeta(ArtifactClasses.builder().build()),
                "test");

        // Deploy an artifact that has a plugin in the DEFAULT scope, but without any
        // parent artifact
        PluginClass pluginClass1 = new PluginClass("type1", "plugin1", "plugin1", null, null, null, "plugin1", null,
        ...
        // Get the available plugins for the plugin artifact itself, should also get the
        // plugin1
        ...
        // Deploy an artifact that has a plugin in the DEFAULT scope with a parent
        // artifact
        PluginClass pluginClass2 = new PluginClass("type2", "plugin2", "plugin2", null, null, null, "plugin2", null,
                Collections.emptyMap());
        ArtifactId pluginArtifactId2 = NamespaceId.DEFAULT.artifact("plugin-artifact2", "0.0.1");
        ArtifactRange parentArtifactRange = new ArtifactRange(artifactId.getNamespace(), artifactId.getArtifact(),
        ...
        writeArtifact(Id.Artifact.fromEntityId(pluginArtifactId2),
                new ArtifactMeta(ArtifactClasses.builder().addPlugin(pluginClass2).build(),
                        Collections.singleton(parentArtifactRange)),
                "test");

        // Get the available plugins for the artifact again, should get plugin1 and
        // plugin2
        ...
        for (PluginClass pluginClass : Arrays.asList(pluginClass1, pluginClass2)) {
            SortedMap<ArtifactDescriptor, PluginClass> result = artifactStore.getPluginClasses(NamespaceId.DEFAULT,
                    parentArtifactRange, pluginClass.getType(), pluginClass.getName(), null, 10,
                    ArtifactSortOrder.UNORDERED);
    ...
    private void assertEqual(Id.Artifact expectedId, ArtifactMeta expectedMeta, String expectedContents,
            ArtifactDetail actual) throws IOException {
