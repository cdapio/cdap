...
/**
 * Test serialize/deserialize TriggerInfo
 */
public class TriggerInfoCodecTest {
  ...
  public void testSerDeserScheduleInfo() {
    List<TriggerInfo> triggerInfos =
      ImmutableList.<TriggerInfo>of(
        new DefaultProgramStatusTriggerInfo("ns", Specifications.from(new WebCrawlApp()), ProgramType.WORKFLOW,
                                            ...
                                            new BasicWorkflowToken(0), Collections.EMPTY_MAP),
    ...
    // TODO: how to deserialize WorkflowToken?
//    Assert.assertEquals(expectedProgramStatusTriggerInfo.getWorkflowToken(),
//                        deserializedProgramStatusTriggerInfo.getWorkflowToken());
  }
}
