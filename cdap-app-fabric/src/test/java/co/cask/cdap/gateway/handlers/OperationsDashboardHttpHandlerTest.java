...
public class OperationsDashboardHttpHandlerTest extends AppFabricTestBase {
  private static final Logger LOG = LoggerFactory.getLogger(OperationsDashboardHttpHandlerTest.class);
  ...
  public void testDashboardDetail() throws Exception {
    ...
    if (4 != dashboardDetail.size()) {
      Assert.fail(dashboardDetail.toString());
    }
