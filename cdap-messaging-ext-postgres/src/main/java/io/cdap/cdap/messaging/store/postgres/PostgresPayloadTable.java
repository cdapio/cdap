...
public class PostgresPayloadTable implements PayloadTable {
  @Override
  public CloseableIterator<Entry> fetch(TopicMetadata metadata, long transactionWritePointer, MessageId messageId,
