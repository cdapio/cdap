...
public class MetricsQueryHandler extends BaseMetricsHandler {
  ...
  // ex: /cdap/apps/appX/flows/process.events.processed
  @GET
  ...
  // ex: /cdap/apps/appX/flows/flowY/process.events.processed
  @GET
  ...
  // ex: /cdap/apps/appX/mapreduce/jobId/mappers/process.entries.in
  @GET
  ...
  // ex: /cdap/apps/appX/flows/flowY/flowlets/flowletZ/process.events.processed
  // ex2: /cdap/services/{service-name}/handlers/{handler-name}/methods/{method-name}/{metric}
  @GET
  ...
  // ex: /cdap/datasets/tickTimeseries/apps/Ticker/flows/TickerTimeseriesFlow/flowlets/saver/store.bytes
  @GET
  @Path("/cdap/datasets/{dataset-id}/apps/{app-id}/flows/{flow-id}/flowlets/{flowlet-id}/{metric}")
