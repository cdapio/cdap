...
public class AggregatedMetricsCollectionServiceTest {
  ...
  public void testPublish() throws InterruptedException {
    ...
    try {
      ...
      service.getCollector(MetricsScope.CDAP, "context", "runId").increment("metric", 1);
      service.getCollector(MetricsScope.CDAP, "context", "runId").increment("metric", 2);
      service.getCollector(MetricsScope.CDAP, "context", "runId").increment("metric", 3);
      service.getCollector(MetricsScope.CDAP, "context", "runId").increment("metric", 4);
      ...
      service.getCollector(MetricsScope.CDAP, "context", "runId").increment("metric", 3, "tag1", "tag2");
      service.getCollector(MetricsScope.CDAP, "context", "runId").increment("metric", 4, "tag2", "tag3");
