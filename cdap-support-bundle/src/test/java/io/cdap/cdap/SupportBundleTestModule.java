 ...
 *
 */
public final class SupportBundleTestModule extends AbstractModule {
  ...
  public SupportBundleTestModule(CConfiguration cConf, @Nullable SConfiguration sConf) {
    ...
    hConf.set("hadoop.tmp.dir",
              new File(localDataDir, cConf.get(Constants.SupportBundle.LOCAL_DATA_DIR)).getAbsolutePath());
  ...
  protected void configure() {
    install(new SupportBundleServiceModule());
