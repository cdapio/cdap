...
import io.cdap.cdap.SupportBundleTaskConfiguration;
import io.cdap.cdap.common.NamespaceNotFoundException;
import io.cdap.cdap.common.conf.CConfiguration;
import io.cdap.cdap.common.namespace.RemoteNamespaceQueryClient;
import io.cdap.cdap.common.utils.DirUtils;
import io.cdap.cdap.job.SupportBundleJob;
...
public class SupportBundleService implements Closeable {
  ...
  SupportBundleService(CConfiguration cConf, RemoteNamespaceQueryClient namespaceQueryClient,
    ...
    this.executorService = Executors.newFixedThreadPool(cConf.getInt(SupportBundle.MAX_THREADS),
                                                        Threads.createDaemonThreadFactory("perform-support-bundle"));
    this.localDir = this.cConf.get(SupportBundle.LOCAL_DATA_DIR);
  ...
  public void deleteOldFoldersIfExceedLimit(File baseDirectory) throws IOException {
    ...
    int folderMaxNumber = cConf.getInt(SupportBundle.MAX_FOLDER_SIZE);
