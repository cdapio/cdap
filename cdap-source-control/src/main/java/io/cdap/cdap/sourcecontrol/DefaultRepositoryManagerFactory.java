 ...
 */
public class DefaultRepositoryManagerFactory implements RepositoryManagerFactory {
  ...
  @Inject
  public DefaultRepositoryManagerFactory(SecureStore secureStore,
  ...
  @Override
  public RepositoryManager create(NamespaceId namespace)
