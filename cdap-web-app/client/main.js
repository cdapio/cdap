...
define(['core/application', 'helpers/localstorage-adapter'], function (Application, SSAdapter) {
    ...
    C.Router.map(function () {
        ...
        this.resource('Spark', { path: '/spark/:spark_id' }, function () {
            ...
            this.resource('SparkStatus', { path: '/' }, function () {
                // These live in SparkStatus so they can visually overlay the Spark Job.
                this.route('Config', { path: '/config' });
            });
    ...
    $.extend(C, {
        ...
        SparkStatusRoute: basicRouter.extend({
            model: function () {
                return this.modelFor('Spark');
            }
        }),

        SparkStatusConfigRoute: basicRouter.extend({
            renderTemplate: function () {
        ...
        SparkHistoryRoute: basicRouter.extend({
            model: function () {
                return this.modelFor('Spark');
            }
        }),
