	...
	var Controller = Ember.Controller.extend({
		...
		load: function () {
			...
			for (var i = 0; i < streams.length; i ++) {
				...
				objects[i].trackMetric('/system/streams/{id}/collect.events', 'aggregates', 'events');
		...
		setFlowletLabel: function (label) {
			...
			var paths = {
				'rate': '/system/apps/{app}/flows/{flow}/flowlets/{id}/process.events.in',
				'pending': '/system/apps/{app}/flows/{flow}/flowlets/{id}/process.events.pending',
				'aggregate': '/system/apps/{app}/flows/{flow}/flowlets/{id}/process.events.processed'
			};
			var kinds = {
				'rate': 'rates',
				'pending': 'aggregates',
