 ...
 */
public class KafkaNotificationService2 extends AbstractIdleService implements NotificationService {
  private static final Logger LOG = LoggerFactory.getLogger(KafkaNotificationService2.class);
  ...
  @Inject
  public KafkaNotificationService2(KafkaClient kafkaClient, NotificationFeedManager feedManager,
