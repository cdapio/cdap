...
public class MetricsDeleteTest extends MetricsSuiteTestBase {
  ...
  public void testContextDelete() throws Exception {
    ...
    collector = collectionService.getCollector(MetricsScope.CDAP, "WCount.f.WordCounter.counter", "0");
    collector.increment("process.events.processed", 4);
    collector.increment("process.events.out", 3);

    collector = collectionService.getCollector(MetricsScope.CDAP, "WCount.f.WCounter.counter", "0");
    ...
    String base = "/v2/metrics/cdap/apps/WCount/flows";
  ...
  public void testContextAndMetricDelete() throws Exception {
    ...
    String base = "/v2/metrics/cdap/apps/WCount/flows/WordCounter";
    // make sure data is there
