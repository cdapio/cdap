 ...
 */
public class ProcedureHandlerTest extends GatewayTestService {
  ...
  public static void startProcedureServer() throws Exception {
    ...
    DiscoveryService discoveryService = GatewayTestService.getInjector().getInstance(DiscoveryService.class);
