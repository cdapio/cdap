...
public interface Explore {
   ...
   *               {@link Status.EStatus#FINISHED}. Can be called multiple times, until it returns an empty list
  ...
  /**
   * Cancel a running Hive operation. After the operation moves into a {@link Status.EStatus#CANCELED},
