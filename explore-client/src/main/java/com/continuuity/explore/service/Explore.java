...
public interface Explore {
   ...
   *               {@link com.continuuity.explore.service.Status.EStatus#FINISHED}.
   * @param handle handle returned by {@link #execute(String)}.
   ...
   *               {@link com.continuuity.explore.service.Status.EStatus#FINISHED}. Can be called multiple times, until it returns an empty list
  ...
  /**
   * Cancel a running Hive operation. After the operation moves into a {@link com.continuuity.explore.service.Status.EStatus#CANCELED},
