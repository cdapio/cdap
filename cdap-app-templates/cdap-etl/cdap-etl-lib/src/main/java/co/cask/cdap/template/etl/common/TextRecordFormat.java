...
/**
 * Kafka event record format that interprets the entire message payload as a single string.
 */
public class TextRecordFormat extends KafkaEventRecord<StructuredRecord> {
