...
/**
 * Kafka record format that interprets message payload as data in Combined Log Format.
 ...
 *
 */
public class CombinedLogRecordFormat extends KafkaEventRecord<StructuredRecord> {

  @Override
  public StructuredRecord read(ByteBuffer byteBuffer) throws UnexpectedFormatException {
    String bodyAsStr = Bytes.toString(byteBuffer);
