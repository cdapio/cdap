 ...
 * Used with ByteBuffers for Kafka events
 */
public class GrokRecordFormat extends KafkaEventRecord<StructuredRecord> {
  ...
  public StructuredRecord read(ByteBuffer byteBuffer) throws UnexpectedFormatException {
    String bodyAsStr = Bytes.toString(byteBuffer, Charsets.UTF_8);
