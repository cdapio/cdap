...
public class BatchCubeSink extends BatchWritableSink<StructuredRecord, byte[], CubeFact> {
  ...
  /**
   * Config class for BatchCubeSink
   */
  public static class BatchCubeSinkConfig extends PluginConfig {
    ...
    public BatchCubeSinkConfig(String name, String resolutions, String datasetOther,
  ...
  private final BatchCubeSinkConfig config;

  public BatchCubeSink(BatchCubeSinkConfig realtimeCubeConfig) {
    this.config = realtimeCubeConfig;
  }
  ...
  protected Map<String, String> getProperties() {
    ...
    if (!Strings.isNullOrEmpty(config.datasetOther)) {
      ...
      Map<String, String> customProperties = GSON.fromJson(config.datasetOther, STRING_MAP_TYPE);
      properties.putAll(customProperties);
    }
    properties.put(Properties.BatchReadableWritable.NAME, config.name);
