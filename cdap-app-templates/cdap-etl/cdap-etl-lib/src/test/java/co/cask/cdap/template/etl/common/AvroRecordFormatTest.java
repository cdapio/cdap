...
public class AvroRecordFormatTest {
  ...
  public void testMultipleReads() throws Exception {
    ...
    RecordFormat<ByteBuffer, StructuredRecord> format =
      co.cask.cdap.template.etl.common.RecordFormats.createInitializedFormat(formatSpecification);
  ...
  public void testFlatRecord() throws Exception {
    ...
    RecordFormat<ByteBuffer, StructuredRecord> format = co.cask.cdap.template.etl.common
      .RecordFormats.createInitializedFormat(formatSpecification);
