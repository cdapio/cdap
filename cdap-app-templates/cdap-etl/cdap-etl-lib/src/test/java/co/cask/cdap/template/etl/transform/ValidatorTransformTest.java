...
import co.cask.cdap.template.etl.validator.ApacheValidator;
...
public class ValidatorTransformTest {
  ...
  public void testValidatorTransformWithMap() throws Exception {
    ...
    Assert.assertTrue(ApacheValidator.ApacheValidatorWrapper.isUrl("http://xyz.com"));
    ...
    transform.setUpInitialScript(new MockTransformContext(), ImmutableList.<Validator>of(new ApacheValidator()));
