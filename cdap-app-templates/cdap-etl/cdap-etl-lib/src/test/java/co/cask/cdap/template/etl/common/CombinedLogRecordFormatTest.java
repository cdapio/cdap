...
import co.cask.cdap.data.format.CombinedLogRecordFormat;
...
public class CombinedLogRecordFormatTest {
  ...
  public void testCLFLogWithNull() throws UnsupportedTypeException, UnexpectedFormatException {
    co.cask.cdap.template.etl.common.CombinedLogRecordFormat format =
      new co.cask.cdap.template.etl.common.CombinedLogRecordFormat();
    FormatSpecification spec = new FormatSpecification(co.cask.cdap.data.format.
  ...
  public void testCLFLog() throws UnsupportedTypeException, UnexpectedFormatException {
    co.cask.cdap.template.etl.common.CombinedLogRecordFormat format =
      new co.cask.cdap.template.etl.common.CombinedLogRecordFormat();
    FormatSpecification spec = new FormatSpecification(co.cask.cdap.template.etl.common.CombinedLogRecordFormat
