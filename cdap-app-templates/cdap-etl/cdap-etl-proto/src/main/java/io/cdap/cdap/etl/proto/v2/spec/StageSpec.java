...
public class StageSpec implements Serializable {
  ...
  private StageSpec(String name, PluginSpec plugin, Map<String, Schema> inputSchemas, List<String> inputStages,
                    @Nullable Schema outputSchema,  Schema errorSchema, Map<String, Schema> portSchemas,
                    Map<String, Port> outputPorts,  boolean stageLoggingEnabled, boolean processTimingEnabled,
  ...
  public List<String> getInputStages() {
    ...
    if ((inputStages == null || inputStages.isEmpty()) && !inputSchemas.isEmpty()) {
      return ImmutableList.copyOf(inputSchemas.keySet());
    }
    return inputStages;
  }
  ...
  public static class Builder {
    ...
    public Builder addInputStage(String stageName) {
        this.inputStages.add(stageName);
        return this;
    }

    public Builder addInputStages(List<String> inputStages) {
        this.inputStages.addAll(inputStages);
        return this;
    }
    ...
    public StageSpec build() {
      return new StageSpec(name, plugin, inputSchemas, inputStages, outputSchema, errorSchema, portSchemas, outputs,
