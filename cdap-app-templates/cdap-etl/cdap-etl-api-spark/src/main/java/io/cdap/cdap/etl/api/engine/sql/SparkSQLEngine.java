...
public interface SparkSQLEngine<KEY_IN, VALUE_IN, KEY_OUT, VALUE_OUT>
   ...
   */
  @Nullable
  SparkPushDataset<StructuredRecord> getSparkPushProvider(SparkContext sparkContext, SQLPushRequest pushRequest);
   ...
   */
  @Nullable
  SparkPullDataset<StructuredRecord> getSparkPullProvider(SparkContext sparkContext, SQLPullRequest pullRequest);
