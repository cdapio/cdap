  ...
  public void configurePipeline(PipelineConfigurer pipelineConfigurer) {
    ...
    if (config.millis < 1) {
      stageConfigurer.addValidationFailure(
        ValidationFailure.createConfigPropertyFailure("Value of property millis can not be less than 1.",
                                                      stageConfigurer.getStageName(), "millis",
                                                      "Value of property millis must be atleast 1."));
    }
