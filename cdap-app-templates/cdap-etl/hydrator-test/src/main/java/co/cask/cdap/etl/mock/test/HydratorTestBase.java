...
public class HydratorTestBase extends TestBase {
  ...
  private static final Set<PluginClass> BATCH_MOCK_PLUGINS = ImmutableSet.of(
    ...
    co.cask.cdap.etl.mock.batch.MockSink.PLUGIN_CLASS, MockRuntimeDatasetSink.PLUGIN_CLASS,
    co.cask.cdap.etl.mock.batch.MockSource.PLUGIN_CLASS, MockRuntimeDatasetSource.PLUGIN_CLASS,
