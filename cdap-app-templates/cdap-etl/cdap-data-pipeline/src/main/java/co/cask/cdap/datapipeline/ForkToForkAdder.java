...
/**
 * Implementation of the {@link WorkflowProgramAdder} which adds nodes on the Fork whose parent is another Fork in the
 * Workflow.
...
public class ForkToForkAdder<T extends WorkflowForkConfigurer> implements WorkflowProgramAdder {
  ...
  public ForkToForkAdder(WorkflowProgramAdder parent, T configurer) {
    this.parent = parent;
