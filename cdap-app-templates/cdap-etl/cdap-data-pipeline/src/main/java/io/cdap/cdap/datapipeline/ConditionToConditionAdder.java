...
/**
 * Implementation of {@link WorkflowProgramAdder} which adds node to the branch of the Condition whose parent is
 * another Condition.
 * @param <T> type of the current configurer
 */
public class ConditionToConditionAdder<T extends WorkflowConditionConfigurer> implements WorkflowProgramAdder {

  private final WorkflowProgramAdder parent;
  private final T configurer;

  public ConditionToConditionAdder(WorkflowProgramAdder parent, T configurer) {
    this.parent = parent;
