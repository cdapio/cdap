...
public class BrowseEntity {
  ...
  private BrowseEntity(String name, String path, String type, boolean canSample, boolean canExplore,
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, path, type, canSample, canExplore, properties);
  }
  ...
  public static class Builder {
    ...
    public Builder canExplore(boolean canExplore) {
      this.canExplore = canExplore;
      return this;
    }
    ...
    public BrowseEntity build() {
      return new BrowseEntity(name, path, type, canSample, canExplore, properties);
    }
  }
}
