...
public interface SQLDialectConverter {
     ...
     */
    void validate(String expression, SQLDialect srcDialect, Schema schema);
     ...
     */
    String convert(String expression, SQLDialect srcDialect, SQLDialect destDialect, Schema schema);
}
