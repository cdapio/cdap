 ...
 */
public class PipelineTransformOperation extends PipelineOperation {
   ...
   */
  public PipelineTransformOperation(String name, String description, List<String> inputFields, String... outputFields) {
   ...
   */
  public PipelineTransformOperation(String name, String description, List<String> inputFields,
