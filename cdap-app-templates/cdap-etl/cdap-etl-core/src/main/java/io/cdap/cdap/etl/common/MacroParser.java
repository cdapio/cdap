...
/**
 * Provides a parser to validate the syntax of and evaluate macros. This is copied from cdap-app-fabric to
 * workaround CDAP-18361
 * TODO: remove once we have the evaluate macro functionality at runtime
 */
