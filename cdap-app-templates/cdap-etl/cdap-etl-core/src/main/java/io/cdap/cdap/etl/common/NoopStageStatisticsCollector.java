...
/**
 * Implementation of {@link StageStatisticsCollector} which is no-op. This implementation is used
 * particularly in the Spark Streaming pipelines and possibly when the collection of the stage level
