...
/**
 * Mock {@link PluginConfigurer} for unit tests. No-op for dataset methods. Use
 * the setter methods to populate the plugin objects that should be returned by
 * the PluginConfigurer methods.
 */
    ...
    private static class Value {
        ...
        public Value(Object plugin, Set<ArtifactId> artifacts) {
            ...
            for (ArtifactId artifactId : artifacts) {
                this.artifacts.put(artifactId, new PluginClass("type", "name", "desc", null, null, null, "clsname",
                        "cfgfield", ImmutableMap.<String, PluginPropertyField>of()));
            }
        }
    }
