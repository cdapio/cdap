...
public class ReportSummary {
  ...
  public static ReportSummary getEmptyReportSummary(long start, long end) {
    return new ReportSummary(Collections.emptyList(), start, end, Collections.emptyList(),
                             new DurationStats(null, null, null), new StartStats(null, null),
