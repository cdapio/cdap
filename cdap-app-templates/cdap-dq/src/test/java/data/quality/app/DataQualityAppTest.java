...
public class DataQualityAppTest extends TestBase {
  ...
  private static final Type TOKEN_TYPE_SET_FIELD_DETAIL =
    new TypeToken<HashSet<FieldDetail>>() { }.getType();
  ...
  public void test() throws Exception {
    ...
    CreateAppRequest<DataQualityApp.ConfigClass> createAppRequest = new CreateAppRequest<>(
      new ArtifactSummary(appArtifact.getName(), appArtifact.getVersion().getVersion(), false),
      new DataQualityApp.ConfigClass());
    ApplicationManager applicationManager = deployApplication(appId, createAppRequest);
