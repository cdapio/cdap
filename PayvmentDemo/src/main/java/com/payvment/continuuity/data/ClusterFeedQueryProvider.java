 ...
 * Example queries:
 * <pre>
 *   http://localhost:10010/query/feedreader/readactivity?clusterid=3&limit=10
 *   <p>
 *   http://localhost:10010/query/feedreader/readpopular?clusterid=3&numhours=24&limit=10
 * </pre>
 */
public class ClusterFeedQueryProvider extends QueryProvider {
  ...
  public void configure(QuerySpecifier specifier) {
    ...
    specifier.contentType("application/json");
   ...
   */
  @Override
  public String process(String methodName, Map<String, String> args) {
    if (this.reader == null) {
    ...
    if (methodName.equals("readactivity")) {
      ...
      return executePopularFeedRead(clusterid, numhours, limit, offset);
