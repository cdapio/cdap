...
- Retrieve the list of topics generated by the *SparkWikipediaAnalyzer* program:
  ...
  .. container:: highlight
    ...
    .. parsed-literal::
      |$| cdap-cli.sh execute |example|.\ |example-service|

      |$| curl -w'\\n' localhost:10000/v3/namespaces/default/apps/|example|/services/|example-service|/methods/v1/functions/lda/topics
