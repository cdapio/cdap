...
.. toctree::
   ...
   CDAP Sandbox <local-sandbox/index>
...
The :ref:`CDAP Sandbox <local-sandbox-index>` includes all that
is needed to develop CDAP applications in your development environment, either your laptop
or a workstation. It has:

- A :ref:`CDAP Sandbox <local-sandbox-index>` that can run on a single machine in a single JVM. It provides all of
...
#. Obtain the CDAP Sandbox, using :ref:`one of the versions <local-sandbox-setup>`.
