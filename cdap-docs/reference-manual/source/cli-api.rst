...
.. csv-table::
   ...
   **Lifecycle**
   ...
   ``get flow logs <app-id.flow-id> [<start-time>] [<end-time>]``,"Gets the logs of Flow."
   ...
   ``get mapreduce logs <app-id.mapreduce-id> [<start-time>] [<end-time>]``,"Gets the logs of MapReduce Program."
   ...
   ``get procedure logs <app-id.procedure-id> [<start-time>] [<end-time>]``,"Gets the logs of Procedure."
   ...
   ``get runnable logs <app-id.service-id.runnable-id> [<start-time>] [<end-time>]``,"Gets the logs of Runnable."
   ...
   ``get spark logs <app-id.spark-id> [<start-time>] [<end-time>]``,"Gets the logs of Spark Program."
   ...
   **Dataset**
   ...
   ``list dataset instances``,"Lists Datasets."
