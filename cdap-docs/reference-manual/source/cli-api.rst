...
.. csv-table::
   ...
   **Lifecycle**
   ...
   ``load preferences procedure <local-file-path> <content-type> [<app-id.procedure-id>]``,"Set Preferences of a Procedure from a local Config File (supported formats = JSON)."
   ...
   ``set preferences procedure <runtime-args> [<app-id.procedure-id>]``,"Sets the preferences of a Procedure. <runtime-args> is specified in the format ""key1=v1 key2=v2""."
