...
.. csv-table::
   ...
   **Application Lifecycle**
   ``None``,"Sets the preferences of a Worker. <runtime-args> is specified in the format ""key1=v1 key2=v2""."
   ``None``,"Sets preferences of a Worker from a local config file (supported formats = JSON)."
