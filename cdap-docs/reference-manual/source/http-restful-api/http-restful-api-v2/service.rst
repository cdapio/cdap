...
See the :ref:`http-restful-api-v2-lifecycle` for how to control the lifecycle of Services.
...
:ref:`percent-encoding <http-restful-api-v2-conventions-reserved-unsafe-characters>`. See the
