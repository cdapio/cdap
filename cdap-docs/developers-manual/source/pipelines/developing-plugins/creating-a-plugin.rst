...
be a valid ``DatasetId``. Optionally, you can extend from ``ReferenceBatchSource``, which verifies the
...
be a valid ``DatasetId``. Optionally, you can extend from ``ReferenceBatchSink``, which verifies the
...
Optionally, you can extend from ``ReferenceStreamingSource``, which verifies the validity
