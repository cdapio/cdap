...
function download_includes() {
  ...
  test_an_include d5b03428ff9c41ce31666496148115a0 "${cdap_etl}/batch/sink/S3BatchSink.java"
  test_an_include f489c6e7cf44322598ff996c8ac8aac4 "${cdap_etl}/batch/sink/S3ParquetBatchSink.java"
