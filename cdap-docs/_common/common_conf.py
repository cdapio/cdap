...
#
# manual_list is an ordered list of the cdap_manuals
#
...
navbar_list = [
    ...
    ('Guides',       'guides.html'),
    ('Reference',    'reference-manual/index.html'),
...
manuals_complete_list = [
    ['introduction',      'introduction', 'index.html',         'Introduction to CDAP',            'introduction', -1],
    ['developers-manual', 'developers',   'index.html',        u'Developer’s Manual',              'guides',       -1],
