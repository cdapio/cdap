...
.. csv-table:: **Cask Data Application Platform UI Dependencies**
   ...
   "react-file-download","0.3.2","npm","`MIT License <http://opensource.org/licenses/MIT>`__","https://github.com/kennethjiang/react-file-download/blob/master/package.json"
