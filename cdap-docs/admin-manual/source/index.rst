...
- |operations|_
    ...
    - |logging|_ CDAP collects **logs and metrics** for all of its internal services and user applications,
      while CDAP itself can be **monitored through external systems**. Covers **log location**, **logging
      messages**, the **master services logback configuration** and **CDAP support for
      logging** through standard SLF4J (Simple Logging Facade for Java) APIs.
