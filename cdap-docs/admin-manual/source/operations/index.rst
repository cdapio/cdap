...
- |logging|_ CDAP collects **logs and metrics** for all of its internal services, while CDAP itself
  can be **monitored through external systems**. Covers **log location**, **logging
