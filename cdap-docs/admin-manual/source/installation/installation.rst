...
Follow these instructions only if you aren't using a cluster manager such as
:ref:`Cloudera Manager <cloudera-configuring>` or :ref:`Apache Ambari
<ambari-configuring>`. These instructions *do not apply* to the
