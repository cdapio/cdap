...
public class MetricValueTest {
    ...
    public void testGetAllCounts() {
        ...
        long bucketMask = 1 /* first position */ +
                4 /* 2^2 i.e. third position */ +
                256 /* 2^8 i.e. 9th position */ +
                1048576 /* 2^20 i.e. 21st position */;
        MetricValue metricValue = new MetricValue("ignore", new long[] {1, 1, 1, 1}, bucketMask, 0, 0);
