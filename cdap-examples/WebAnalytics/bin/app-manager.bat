...
REM Application Manager for managing application lifecycle for CountRandom application
SET APP_JAR_PREFIX=WebAnalytics

SET APP_NAME=WebAnalytics
SET FLOW_NAME=WebAnalyticsFlow
