...
public class SparkKMeansAppTest extends TestBase {
  ...
  public void test() throws Exception {
    ...
    String response = requestService(new URL(serviceManager.getServiceURL(5, TimeUnit.SECONDS), "centers/1"));
    ...
    URL url = new URL(serviceManager.getServiceURL(5, TimeUnit.SECONDS), "centers/10");
