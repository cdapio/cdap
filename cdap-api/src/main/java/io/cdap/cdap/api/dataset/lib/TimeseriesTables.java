...
public final class TimeseriesTables {
   ...
   *
   * @param timeIntervalToStorePerRow time interval to store per row. See {@link
   *     TimeseriesTable} for details.
   * @return {@link io.cdap.cdap.api.dataset.DatasetProperties} for the data set
   */
  public static DatasetProperties timeseriesTableProperties(int timeIntervalToStorePerRow,
