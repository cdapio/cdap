...
public interface TriggerFactory {
  ...
  /**
   * Creates a trigger which is satisfied whenever at least a certain number of new partitions are
   ...
   * @param numPartitions the minimum number of new partitions added to the dataset to satisfy
   *     the trigger
   * @return a {@link Trigger}
   */
   ...
   * @see #onProgramStatus(String, String, String, ProgramType, String, ProgramStatus...)
   */
  Trigger onProgramStatus(ProgramType programType, String program,
      ProgramStatus... programStatuses);
}
