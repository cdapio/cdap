...
/**
 * Represents one row in a table with a subset of columns. NOTE: Depending on the operation that
 * returns {@link Row} as a result, it may contain all or just a subset of column values.
 */
public interface Row {
   ...
   * @return value of a column or {@code null} if column is not in a subset of columns of this
   *     {@link Row}
   */
  @Nullable
   ...
   * @return value of a column or given default value if column is not in a subset of columns of
   *     this {@link Row}
   */
