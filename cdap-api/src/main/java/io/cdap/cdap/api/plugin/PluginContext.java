...
public interface PluginContext extends FeatureFlagsProvider {
  ...
  /**
   * Gets the {@link PluginProperties} associated with the given plugin id. If a plugin field has a
   * macro, the parameter evaluator is used to evaluate the macro and the evaluated value is used
   * for the plugin field.
   *
   * @param pluginId the unique identifier provide when declaring plugin usage in the program.
   * @param evaluator the macro evaluator that's used to evaluate macro for plugin field if
   *     macro is supported on those fields.
   ...
   *     given properties
   */
  PluginProperties getPluginProperties(String pluginId, MacroEvaluator evaluator)
   ...
   * evaluate the macro and the evaluated value is used for the plugin field.
   *
   * @param pluginId the unique identifier provide when declaring plugin usage in the program.
   * @param evaluator the macro evaluator that's used to evaluate macro for plugin field if
   *     macro is supported on those fields.
