 ...
 * transaction, or they have a need to control their transactions themselves. Such a method can be annotated
 * as follows, for example in a worker:
 *
 * <pre><code>
 * {@literal @}Override
 ...
 * </code></pre>
 *
 * This is especially useful if the method may run longer than the transaction timeout, and it would therefore
