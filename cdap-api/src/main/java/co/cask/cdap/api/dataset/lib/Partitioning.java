...
public class Partitioning {
  ...
  public enum FieldType {
    STRING {
      ...
      public int determineLengthInBytes(byte[] bytes, int offset) {
    ...
    LONG {
      ...
      public Long fromBytes(byte[] bytes, int offset, int length) {
        return Bytes.toLong(bytes, offset, length) ^ Long.MIN_VALUE;
      }
      public boolean validateType(Object value) {
    ...
    INT {
      ...
      public Integer fromBytes(byte[] bytes, int offset, int length) {
        return Bytes.toInt(bytes, offset, length) ^ Integer.MIN_VALUE;
      }
      public boolean validateType(Object value) {
    ...
    public abstract <T> byte[] toBytes(T value);
