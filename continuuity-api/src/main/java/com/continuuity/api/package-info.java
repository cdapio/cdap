 ...
 * the {@link com.continuuity.api.Application} interface. When you implement the
 * {@link com.continuuity.api.Application#configure()} method,
 * you create an {@link com.continuuity.api.ApplicationSpecification}
 * that defines and/or creates all of the components of an
 ...
 *
 * <h1>DataSet</h1>
 * A {@link com.continuuity.api.data.DataSet} defines the storage and
 * retrieval of data. In addition to the several
 * {@link com.continuuity.api.data.DataSet} implementations the Reactor
