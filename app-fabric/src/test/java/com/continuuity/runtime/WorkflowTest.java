...
public class WorkflowTest {
  ...
  public void testWorkflow() throws Exception {
    final ApplicationWithPrograms app = AppFabricServiceWrapper.deployApplicationWithManager(WorkflowApp.class,
  ...
  public void testOneActionWorkflow() throws Exception {
    final ApplicationWithPrograms app = AppFabricServiceWrapper.deployApplicationWithManager
      (OneActionWorkflowApp.class, TEMP_FOLDER_SUPPLIER);
    ProgramRunnerFactory runnerFactory = AppFabricServiceWrapper.getInjector().getInstance(ProgramRunnerFactory.class);
    ProgramRunner programRunner = runnerFactory.create(ProgramRunnerFactory.Type.WORKFLOW);
