...
public class MultiConsumerTest {
  ...
  public void testMulti() throws Exception {
    ...
    final ApplicationWithPrograms app = AppFabricServiceWrapper.deployApplicationWithManager(MultiApp.class,
    ...
    LocationFactory locationFactory = AppFabricServiceWrapper.getInjector().getInstance(LocationFactory.class);
    DataSetAccessor dataSetAccessor = AppFabricServiceWrapper.getInjector().getInstance(DataSetAccessor.class);
