...
public class ProcedureHandlerTest {
  ...
  public static void startProcedureServer() throws Exception {
    ...
    DiscoveryService discoveryService = AppFabricTestsSuite.getInjector().getInstance(DiscoveryService.class);
  ...
  public void testPostProcedureCall() throws Exception {
    ...
    HttpResponse response = 
      AppFabricTestsSuite.doPost("/v2/apps/testApp1/procedures/testProc1/methods/testMethod1", contentStr,
  ...
  public void testPostEmptyProcedureCall() throws Exception {
    HttpResponse response =
      AppFabricTestsSuite.doPost("/v2/apps/testApp1/procedures/testProc1/methods/testMethod1", "",
             new Header[]{new BasicHeader("X-Test", "1234")});
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
  ...
  public void testPostNullProcedureCall() throws Exception {
    HttpResponse response =
      AppFabricTestsSuite.doPost("/v2/apps/testApp1/procedures/testProc1/methods/testMethod1", null,
             new Header[]{new BasicHeader("X-Test", "1234")});
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
  ...
  public void testPostBigContentProcedureCall() throws Exception {
    ...
    HttpPost post = AppFabricTestsSuite.getPost("/v2/apps/testApp1/procedures/testProc1/methods/testMethod1");
    post.setHeader("Expect", "100-continue");
    post.setEntity(entity);

    HttpResponse response = AppFabricTestsSuite.doPost(post);
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
  ...
  public void testGetProcedureCall() throws Exception {
    Map<String, String> content = ImmutableMap.of("key1&", "val1=", "key3", "\"val3\"");
    HttpResponse response =
      AppFabricTestsSuite.doGet("/v2/apps/testApp1/procedures/testProc1/methods/testMethod1?" + getQueryParams(content),
            new Header[]{new BasicHeader("X-Test", "1234")});
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
  }
  ...
  public void testGetEmptyProcedureCall() throws Exception {
    HttpResponse response =
      AppFabricTestsSuite.doGet("/v2/apps/testApp1/procedures/testProc1/methods/testMethod1",
            new Header[]{new BasicHeader("X-Test", "1234")});
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
  ...
  public void testGetNoProcedureCall() throws Exception {
    Map<String, String> content = ImmutableMap.of("key1", "val1", "key3", "val3");
    HttpResponse response =
      AppFabricTestsSuite.doGet("/v2/apps/testApp1/procedures/testProc2/methods/testMethod1&" + getQueryParams
        (content));
    Assert.assertEquals(HttpResponseStatus.NOT_FOUND.getCode(), response.getStatusLine().getStatusCode());
  }
  ...
  public void testGetChunkedProcedureCall() throws Exception {
    ...
    HttpResponse response =
      AppFabricTestsSuite.doGet("/v2/apps/testApp2/procedures/testProc2/methods/testChunkedMethod?"
  ...
  public void testGetErrorProcedureCall() throws Exception {
    Map<String, String> content = ImmutableMap.of("key1", "val1", "key3", "val3");
    HttpResponse response =
      AppFabricTestsSuite.doGet("/v2/apps/testApp2/procedures/testProc2/methods/testExceptionMethod?" +
                                    getQueryParams(content));
    Assert.assertEquals(HttpResponseStatus.INTERNAL_SERVER_ERROR.getCode(), response.getStatusLine().getStatusCode());
  }
  ...
  public void testRealProcedureCall() throws Exception {
    ...
    // Start procedure
    HttpResponse response =
      AppFabricTestsSuite.doPost("/v2/apps/ProcedureTestApp/procedures/TestProcedure/start", null);
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());

    // Make procedure call
    response =
      AppFabricTestsSuite.doGet("/v2/apps/ProcedureTestApp/procedures/TestProcedure/methods/TestMethod?" +
                                    getQueryParams(content));
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
    ...
    // Stop procedure
    response =
      AppFabricTestsSuite.doPost("/v2/apps/ProcedureTestApp/procedures/TestProcedure/stop", null);
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
    ...
    Assert.assertEquals(HttpResponseStatus.OK.getCode(),
                        AppFabricTestsSuite.doDelete("/v2/apps/ProcedureTestApp").getStatusLine().getStatusCode());
