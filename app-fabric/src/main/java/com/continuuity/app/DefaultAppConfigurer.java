...
public class DefaultAppConfigurer implements ApplicationConfigurer {
  ...
  // NOTE: to be removed after datasets API v1 is abandoned
  ...
  @Override
  public void add(String datasetInstanceName, String typeName, DatasetInstanceProperties properties) {
  ...
  @Override
  public void add(Procedure procedure, int instance) {
    Preconditions.checkArgument(procedure != null, "Procedure cannot be null.");
  ...
  @Override
  public void add(MapReduce mapReduce) {
