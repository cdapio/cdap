...
public class MapReduceMetricsWriter {
  ...
  private int calcDiffAndSetMapStat(String key, long value) {
    return calcDiffAndSetTableValue(previousMapStats, MetricsScope.CDAP, key, value);
  }

  private int calcDiffAndSetReduceStat(String key, long value) {
    return calcDiffAndSetTableValue(previousReduceStats, MetricsScope.CDAP, key, value);
  }
