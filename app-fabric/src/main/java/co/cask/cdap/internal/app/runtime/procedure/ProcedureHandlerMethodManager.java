 ...
 */
final class ProcedureHandlerMethodManager extends AbstractExecutionThreadService implements HandlerMethodFactory {

  private static final Logger LOG = LoggerFactory.getLogger(ProcedureHandlerMethodManager.class);
  ...
  private final ProcedureHandlerMethodFactory methodFactory;

  private Thread runThread;

  ProcedureHandlerMethodManager(Program program, DataFabricFacadeFactory dataFabricFacadeFactory,
                                BasicProcedureContextFactory contextFactory,
                                ProcedureHandlerMethodFactory methodFactory) {
  ...
  public HandlerMethod create() {
    try {
      ...
      ProcedureHandlerMethod handlerMethod = methodFactory.create(program, dataFabricFacade, context);
      handlerMethod.init();
