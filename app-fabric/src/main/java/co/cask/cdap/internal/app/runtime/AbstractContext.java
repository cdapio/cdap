...
public abstract class AbstractContext implements DataSetContext, RuntimeContext {
  ...
  public AbstractContext(Program program, RunId runId,
    ...
    if (metricsCollectionService != null) {
      ...
      this.programMetrics = metricsCollectionService.getCollector(MetricsScope.CDAP, metricsContext, "0");
      datasetMetrics = metricsCollectionService.getCollector(MetricsScope.CDAP,
