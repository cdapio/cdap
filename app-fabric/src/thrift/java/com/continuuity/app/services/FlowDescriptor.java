 ...
 * Flow during start.
 */
public class FlowDescriptor implements org.apache.thrift.TBase<FlowDescriptor, FlowDescriptor._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new FlowDescriptorStandardSchemeFactory());
   ...
   */
  public FlowDescriptor(FlowDescriptor other) {
  ...
  public FlowDescriptor deepCopy() {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FlowDescriptor)
      return this.equals((FlowDescriptor)that);
    return false;
  }

  public boolean equals(FlowDescriptor that) {
    if (that == null)
      return false;
  ...
  public int compareTo(FlowDescriptor other) {
    ...
    FlowDescriptor typedOther = (FlowDescriptor)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FlowDescriptor(");
    boolean first = true;
  ...
  private static class FlowDescriptorStandardSchemeFactory implements SchemeFactory {
    public FlowDescriptorStandardScheme getScheme() {
      return new FlowDescriptorStandardScheme();
    }
  }

  private static class FlowDescriptorStandardScheme extends StandardScheme<FlowDescriptor> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FlowDescriptor struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FlowDescriptor struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FlowDescriptorTupleSchemeFactory implements SchemeFactory {
    public FlowDescriptorTupleScheme getScheme() {
      return new FlowDescriptorTupleScheme();
    }
  }

  private static class FlowDescriptorTupleScheme extends TupleScheme<FlowDescriptor> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FlowDescriptor struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FlowDescriptor struct) throws org.apache.thrift.TException {
