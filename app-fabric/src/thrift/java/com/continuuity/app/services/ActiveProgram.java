 ...
 */
public class ActiveProgram implements org.apache.thrift.TBase<ActiveProgram, ActiveProgram._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ActiveProgram");
  ...
  static {
    schemes.put(StandardScheme.class, new ActiveProgramStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ActiveProgramTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ActiveProgram.class, metaDataMap);
  }
   ...
   */
  public ActiveProgram(ActiveProgram other) {
  ...
  public ActiveProgram deepCopy() {
    return new ActiveProgram(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ActiveProgram)
      return this.equals((ActiveProgram)that);
    return false;
  }

  public boolean equals(ActiveProgram that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ActiveProgram other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ActiveProgram typedOther = (ActiveProgram)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ActiveProgram(");
    boolean first = true;
  ...
  private static class ActiveProgramStandardSchemeFactory implements SchemeFactory {
    public ActiveProgramStandardScheme getScheme() {
      return new ActiveProgramStandardScheme();
    }
  }

  private static class ActiveProgramStandardScheme extends StandardScheme<ActiveProgram> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ActiveProgram struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ActiveProgram struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ActiveProgramTupleSchemeFactory implements SchemeFactory {
    public ActiveProgramTupleScheme getScheme() {
      return new ActiveProgramTupleScheme();
    }
  }

  private static class ActiveProgramTupleScheme extends TupleScheme<ActiveProgram> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ActiveProgram struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ActiveProgram struct) throws org.apache.thrift.TException {
