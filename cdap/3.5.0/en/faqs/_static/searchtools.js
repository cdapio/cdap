...
var manuals = {
  "introduction":"Introduction to CDAP","developers-manual":"Developers’ Manual","admin-manual":"Administration Manual","integrations":"Integrations","examples-manual":"Examples, Guides, and Tutorials","reference-manual":"Reference Manual","faqs":"FAQs","hydrator-manual":"Cask Hydrator","tracker-manual":"Cask Tracker" 
};

var manualsArray = new Array(
  "introduction","developers-manual","admin-manual","integrations","examples-manual","reference-manual","faqs","hydrator-manual","tracker-manual" 
);
  ...
  query : function(query) {
    ...
    function displayNextItem() {
      ...
      // search finished, update title and status message
        ...
        if (!resultCount)
          Search.status.text(_('Your search did not match any documents. Please make sure that all words are spelled correctly and that you\'ve not used any special characters (such as hyphens or periods) in your words.'));
        else
          if (resultCount == 1)
