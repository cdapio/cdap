...
public class LogHandlerTestRun extends MetricsSuiteTestBase {
  ...
  public void testMapReduceNext() throws Exception {
    testNext("testApp3", "mapreduce", "testMapReduce1", true, Constants.DEFAULT_NAMESPACE);
    try {
    ...
    testNextNoMax("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
    testNextFilter("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
    testNextNoFrom("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
  }
  ...
  public void testMapReducePrev() throws Exception {
    testPrev("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
    testPrevNoMax("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
    try {
    ...
    testPrevFilter("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
    testPrevNoFrom("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
  }
  ...
  public void testFlowLogs() throws Exception {
    ...
    try {
      testLogs("testApp1", "flows", "testFlow1", Constants.DEFAULT_NAMESPACE);
      Assert.fail();
    } catch (AssertionError e) {
      // should fail
    }
  ...
  public void testMapReduceLogs() throws Exception {
    testLogs("testApp3", "mapreduce", "testMapReduce1", Constants.DEFAULT_NAMESPACE);
  ...
  public void testAdapterLogs() throws Exception {
    ...
    testLogs("testTemplate1", "mapreduce", "testMapReduce1", MockLogReader.TEST_NAMESPACE);
    ...
    testLogsRunId("testTemplate1", "mapreduce", "testMapReduce1", MockLogReader.TEST_NAMESPACE);
  }
  ...
  private void testBatchAdapterLogs(String namespaceId, String templateId, String mrName,
    ...
    HttpResponse response = doGet(getVersionedAPIPath(logsUrl, namespaceId));
    Assert.assertEquals(HttpResponseStatus.OK.getCode(), response.getStatusLine().getStatusCode());
    String out = EntityUtils.toString(response.getEntity());
    List<String> logLines = Lists.newArrayList(Splitter.on("\n").omitEmptyStrings().split(out));
    Assert.assertEquals(15, logLines.size());
