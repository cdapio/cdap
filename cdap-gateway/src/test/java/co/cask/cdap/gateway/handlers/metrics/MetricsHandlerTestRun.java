...
public class MetricsHandlerTestRun extends MetricsSuiteTestBase {
  ...
  private String getContext(String nameSpace, String appName, String programType,
    ...
    return MetricTags.NAMESPACE + "." + nameSpace + "." + MetricTags.APP + "." + appName + "." +
      MetricTags.PROGRAM_TYPE + "." + programType + "." + MetricTags.PROGRAM + "." +
      programName + "." + MetricTags.FLOWLET + "." + flowletName;
  }
