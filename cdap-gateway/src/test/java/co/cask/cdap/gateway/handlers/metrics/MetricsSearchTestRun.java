...
public class MetricsSearchTestRun extends MetricsSuiteTestBase {
  ...
  private static void setupMetrics() throws Exception {
    ...
    MetricsCollector collector =
      collectionService.getCollector(MetricsScope.USER, getFlowletContext(Constants.DEFAULT_NAMESPACE, "WordCount",
    ...
    collector.increment("reads", 1);
    collector = collectionService.getCollector(MetricsScope.USER,
                                               getFlowletContext(Constants.DEFAULT_NAMESPACE, "WCount", "WCounter",
                                                                 "splitter"));
    collector.increment("reads", 1);
    collector = collectionService.getCollector(MetricsScope.USER,
                                               getFlowletContext(Constants.DEFAULT_NAMESPACE, "WCount", "WCounter",
