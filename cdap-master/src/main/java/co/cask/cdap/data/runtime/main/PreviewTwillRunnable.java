 ...
 */
public class PreviewTwillRunnable extends AbstractMasterTwillRunnable {
  private static final Logger LOG = LoggerFactory.getLogger(MetricsTwillRunnable.class);

  private Injector injector;

  public PreviewTwillRunnable(String name, String cConfName, String hConfName) {
  ...
  protected Injector doInit(TwillContext context) {
    ...
    getCConfiguration().set(Constants.Preview.ADDRESS, context.getHost().getCanonicalHostName());
    LOG.info("{} Setting host name to {}", name, context.getHost().getCanonicalHostName());

    String txClientId = String.format("cdap.service.%s.%d", Constants.Service.PREVIEW_HTTP, context.getInstanceId());
  ...
  public void addServices(List<? super Service> services) {
    services.add(injector.getInstance(PreviewService.class));
  }
