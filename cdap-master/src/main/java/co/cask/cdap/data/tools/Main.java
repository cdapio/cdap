...
//    executorFactory = injector.getInstance(TransactionExecutorFactory.class);
  ...
  private void performUpgrade() throws Exception {
    ...
    MDSUpgrader mdsUpgrad = injector.getInstance(MDSUpgrader.class);
    mdsUpgrad.upgrade();

    LOG.debug("Upgrading logs ...");
    LogUpgrader logUpgrade = injector.getInstance(LogUpgrader.class);
    logUpgrade.upgrade();

    LOG.debug("Upgrading archives ...");
    ArchiveUpgrader archiveUpgrade = injector.getInstance(ArchiveUpgrader.class);
