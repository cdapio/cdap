...
/**
 * Checks that the configured FileSystem is available and the root path has the correct
 * permissions.
 */
...
public class FileSystemCheck extends AbstractMasterCheck {
  ...
  @Inject
  private FileSystemCheck(CConfiguration cConf, Configuration hConf,
  ...
  public void run() throws IOException {
    ...
    LOG.info("Checking that user {} has permission to write to {} on the FileSystem.", user,
        rootPath);
    if (rootExists) {
