...
/**
 * Unit test for {@link LogSaverServiceMain}.
 */
public class LogSaverServiceMainTest extends MasterServiceMainTestBase {
  ...
  @Test
  public void testLogSaverService() throws Exception {
    Injector injector = getServiceMainInstance(LogSaverServiceMain.class).getInjector();
