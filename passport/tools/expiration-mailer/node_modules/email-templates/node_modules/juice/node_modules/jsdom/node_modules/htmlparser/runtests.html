			...
			while (Tautologistics.NodeHtmlParser.Tests.length) {
				...
				try {
					...
					var handler = (test.type == "rss") ?
						new Tautologistics.NodeHtmlParser.RssHandler(handlerCallback, test.properties.handler)
						:
						new Tautologistics.NodeHtmlParser.DefaultHandler(handlerCallback, test.properties.handler)
						;
					var parser = new Tautologistics.NodeHtmlParser.Parser(handler, test.properties.parser);
