			...
			while (Tautologistics.NodeHtmlParser.Tests.length) {
				...
				try {
					...
					var handler = (test.type == "rss") ?
						new Tautologistics.NodeHtmlParser.RssHandler(handlerCallback, test.properties)
						:
						new Tautologistics.NodeHtmlParser.DefaultHandler(handlerCallback, test.properties)
						;
