@echo OFF
REM Application Manager for managing application lifecycle for CountCounts application 
SET APP_JAR_PREFIX=CountCounts

SET APP_NAME=CountCounts
SET FLOW_NAME=CountCounts
SET PROCEDURE_NAME=CountCountsProcedure
