@echo OFF
REM Application Manager for managing application lifecycle for CountOddAndEven application 
SET APP_JAR_PREFIX=CountOddAndEven

SET APP_NAME=CountOddAndEven
SET FLOW_NAME=CountOddAndEven
