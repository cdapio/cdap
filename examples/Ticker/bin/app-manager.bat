@echo OFF
REM Application Manager for managing application lifecycle for Ticker application 
SET APP_JAR_PREFIX=Ticker

SET APP_NAME=Ticker
SET FLOW_NAME1=TickerSeriesFlow
SET FLOW_NAME2=OrderDataFlow
SET PROCEDURE_NAME1=Timeseries
SET PROCEDURE_NAME2=Orders
SET PROCEDURE_NAME3=Summary
...
:START
CALL :POST %APP_NAME% flows %FLOW_NAME1% start
CALL :POST %APP_NAME% flows %FLOW_NAME2% start
CALL :POST %APP_NAME% procedures %PROCEDURE_NAME1% start
CALL :POST %APP_NAME% procedures %PROCEDURE_NAME2% start
CALL :POST %APP_NAME% procedures %PROCEDURE_NAME3% start
GOTO :EOF

:STOP
CALL :POST %APP_NAME% flows %FLOW_NAME1% stop
CALL :POST %APP_NAME% flows %FLOW_NAME2% stop
CALL :POST %APP_NAME% procedures %PROCEDURE_NAME1% stop
CALL :POST %APP_NAME% procedures %PROCEDURE_NAME2% stop
CALL :POST %APP_NAME% procedures %PROCEDURE_NAME3% stop
GOTO :EOF
