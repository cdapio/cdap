...
if [ "x$action" == "xdeploy" ]; then
  ...
  program_action $app "TickTimeseriesFlow" "flow" $action $host
  program_action $app "OrderDataFlow" "flow" $action $host
  program_action $app "Timeseries" "procedure" $action $host
  program_action $app "Orders" "procedure" $action $host
  program_action $app "Summary" "procedure" $action $host
fi
