...
function usage() {
  ...
  echo "Usage: $script --action <deploy|start|stop|status|run> [--host <hostname>]"
  echo ""
  echo "  Options"
  echo "    --action    Specifies the action to be taken on the application. run starts the mapreduce job"
