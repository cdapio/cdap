...
public class AccessLogTest extends ReactorTestBase {
  ...
  public void test() throws Exception {
    ...
    try {
      ...
      RuntimeMetrics metrics = RuntimeStats.getFlowletMetrics("accessLogAdvanced", "pageViewFlow", "pageCount");
  ...
  private void sendData(ApplicationManager appManager, long now)
    ...
    StreamWriter streamWriter = appManager.getStreamWriter("logEventsAdvanced");
  ...
  private void verifyCountProcedure(ApplicationManager appManager)
    ...
    // Start a Procedure
    ProcedureManager procedureManager = appManager.startProcedure(AccessLogApp.PageViewProcedure.class.getSimpleName());
    ...
    try {
      ...
      String response = client.query("getDist", ImmutableMap.of("page", "http://www.continuuity.com"));
