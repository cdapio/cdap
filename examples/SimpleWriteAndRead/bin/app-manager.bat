@echo OFF
REM Application Manager for managing application lifecycle for SimpleWriteAndRead application 
SET APP_JAR_PREFIX=SimpleWriteAndRead

SET APP_NAME=SimpleWriteAndRead
SET FLOW_NAME=SimpleWriteAndRead
