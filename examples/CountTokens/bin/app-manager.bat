@echo OFF
REM Application Manager for managing application lifecycle for CountTokens application 
SET APP_JAR_PREFIX=CountTokens

SET APP_NAME=CountTokens
SET FLOW_NAME=CountTokens
