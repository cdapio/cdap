...
define(['core/controllers/app', 'core/controllers/mapreduce-config', 'core/controllers/mapreduce-status',
        ...
        'core/controllers/userservice-log', 'core/controllers/data-explore', 'core/controllers/spark-log',
        'core/controllers/spark-config', 'core/controllers/spark-status', 'core/controllers/spark-history'],
    function () {
