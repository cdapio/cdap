...
public class ExploreMetadataTest extends BaseHiveExploreServiceTest {
    ...
    assertStatementResult(future, true,
                          ...
                          Lists.newArrayList(
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject("default"),
                              new QueryResult.ResultObject("my_table"),
                              new QueryResult.ResultObject("TABLE"),
                              new QueryResult.ResultObject("Cask CDAP Dataset")
                            )),
                            new QueryResult(ImmutableList.of(
                              new QueryResult.ResultObject(""),
                              new QueryResult.ResultObject("default"),
                              new QueryResult.ResultObject("other_table"),
                              new QueryResult.ResultObject("TABLE"),
                              new QueryResult.ResultObject("Cask CDAP Dataset")
                            ))
                          )
  ...
  public void testGetTypeInfo() throws Exception {
    ...
    assertStatementResult(future, true,
                          ...
                          Lists.newArrayList(
                            new QueryResult(ImmutableList.of(
                              new QueryResult.ResultObject("VOID"),
                              new QueryResult.ResultObject(0),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject((short) 1),
                              new QueryResult.ResultObject(false),
                              new QueryResult.ResultObject((short) 3),
                              new QueryResult.ResultObject(true),
                              new QueryResult.ResultObject(false),
                              new QueryResult.ResultObject(false),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject((short) 0),
                              new QueryResult.ResultObject((short) 0),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject())),
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject(16),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                            ...
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject(-6),
                            ...
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject(-5),
                              new QueryResult.ResultObject(19),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject((short) 1),
                            ...
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject(6),
                              new QueryResult.ResultObject(7),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject((short) 1),
                            ...
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject(8),
                              new QueryResult.ResultObject(15),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject((short) 1),
                            ...
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject(12),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              ...
                              new QueryResult.ResultObject())),
                            new QueryResult(ImmutableList.of(
                              new QueryResult.ResultObject("CHAR"),
    ...
    assertStatementResult(future, true,
                          ...
                          Lists.newArrayList(
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject("default"),
                              new QueryResult.ResultObject("my_table"),
                              new QueryResult.ResultObject("key"),
                              new QueryResult.ResultObject(12),
                              new QueryResult.ResultObject("STRING"),
                              new QueryResult.ResultObject(2147483647),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(1),
                              ...
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(1),
                              new QueryResult.ResultObject("YES"),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject("NO"))),
                            new QueryResult(ImmutableList.of(
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject("default"),
                              new QueryResult.ResultObject("my_table"),
                              new QueryResult.ResultObject("value"),
                              new QueryResult.ResultObject(2002),
                              new QueryResult.ResultObject("struct<name:string,ints:array<int>>"),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
  ...
  public void testGetTableTypes() throws Exception {
    ...
    assertStatementResult(future, true,
                          ...
                          Lists.newArrayList(
                            new QueryResult(ImmutableList.of(new QueryResult.ResultObject("TABLE"))),
                            new QueryResult(ImmutableList.of(new QueryResult.ResultObject("TABLE"))),
                            new QueryResult(ImmutableList.of(new QueryResult.ResultObject("VIEW"))),
                            new QueryResult(ImmutableList.of(new QueryResult.ResultObject("INDEX_TABLE")))
                          )
    );
  }
    ...
    assertStatementResult(future, true,
                          ...
                          Lists.newArrayList(
                            ...
                            new QueryResult(ImmutableList.of(
                              ...
                              new QueryResult.ResultObject(""),
                              new QueryResult.ResultObject(1),
                              new QueryResult.ResultObject("org.apache.hadoop.hive.ql.exec.FunctionInfo"))),
                            new QueryResult(ImmutableList.of(
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject(),
                              new QueryResult.ResultObject("!="),
