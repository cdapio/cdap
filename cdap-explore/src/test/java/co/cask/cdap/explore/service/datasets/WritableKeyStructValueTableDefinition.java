...
/**
 * Simple key value table for testing, which is only record writable, not scannable.
 */
public class WritableKeyStructValueTableDefinition extends
  AbstractDatasetDefinition<WritableKeyStructValueTableDefinition.KeyStructValueTable, DatasetAdmin> {
  ...
  public static class KeyStructValueTable extends AbstractDataset
    implements RecordWritable<KeyValue> {
