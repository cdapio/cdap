...
public abstract class OrderedTableTest<T extends OrderedTable> {
  ...
  public void testTxUsingMultipleTables() throws Exception {
    ...
    try {
      ...
      OrderedTable table1_1 = getTable("table1");
      ((TransactionAware) table1_1).startTx(tx1);
      // write r1->c1,v1 but not commit
      table1_1.put(R1, a(C1), a(V1));
      OrderedTable table2_1 = getTable("table2");
      ...
      OrderedTable table2_2 = getTable("table2");
      ((TransactionAware) table2_2).startTx(tx2);
      // write r1->c1,v1 but not commit
      table2_2.put(R1, a(C1), a(V2));
      OrderedTable table3_2 = getTable("table3");
      ...
      OrderedTable table3_3 = getTable("table3");
      ((TransactionAware) table3_3).startTx(tx3);
      // write r1->c1,v1 but not commit
      table3_3.put(R1, a(C1), a(V3));
      OrderedTable table4_3 = getTable("table4");
  ...
  private void testConflictDetection(ConflictDetection level) throws Exception {
    ...
    try {
      ...
      Transaction tx1 = txClient.startShort();
      OrderedTable table1_1 = getTable("table1", level);
      ((TransactionAware) table1_1).startTx(tx1);
      // write r1->c1,v1 but not commit
      table1_1.put(R1, a(C1), a(V1));
      ...
      // start new tx
      Transaction tx2 = txClient.startShort();
      OrderedTable table2_2 = getTable("table2", level);
      ((TransactionAware) table2_2).startTx(tx2);
      ...
      // start new tx
      Transaction tx3 = txClient.startShort();
      OrderedTable table1_3 = getTable("table1", level);
      ...
      Transaction tx4 = txClient.startShort();
      OrderedTable table1_4 = getTable("table1", level);
      ...
      // start new tx
      Transaction tx5 = txClient.startShort();
      OrderedTable table1_5 = getTable("table1", level);
      ...
      // start new tx
      Transaction tx6 = txClient.startShort();
      OrderedTable table1_6 = getTable("table1", level);
      ...
      Transaction tx7 = txClient.startShort();
      OrderedTable table1_7 = getTable("table1", level);
      ...
      OrderedTable table1_8 = getTable("table1", level);
      ...
      OrderedTable table1_9 = getTable("table1", level);
