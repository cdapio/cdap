 ...
 * {@link co.cask.cdap.api.dataset.table.OrderedTable}
...
public abstract class BufferingOrderedTable extends AbstractOrderedTable
   ...
   */
  public BufferingOrderedTable(String name, ConflictDetection conflictLevel) {
    ...
    this.nameAsTxChangePrefix = Bytes.add(new byte[]{(byte) getTransactionAwareName().length()},
                                          Bytes.toBytes(getTransactionAwareName()));
