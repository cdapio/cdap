...
public class TOpenTable implements org.apache.thrift.TBase<TOpenTable, TOpenTable._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new TOpenTableStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TOpenTableTupleSchemeFactory());
  }
  ...
  public TOpenTable setTable(String table) {
    this.table = table;
    return this;
  }
  ...
  public TOpenTable setMetric(String metric) {
    this.metric = metric;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TOpenTable)
      return this.equals((TOpenTable)that);
    return false;
  }

  public boolean equals(TOpenTable that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TOpenTable other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TOpenTable typedOther = (TOpenTable)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TOpenTable(");
    boolean first = true;
  ...
  private static class TOpenTableStandardSchemeFactory implements SchemeFactory {
    public TOpenTableStandardScheme getScheme() {
      return new TOpenTableStandardScheme();
    }
  }

  private static class TOpenTableStandardScheme extends StandardScheme<TOpenTable> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TOpenTable struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOpenTable struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TOpenTableTupleSchemeFactory implements SchemeFactory {
    public TOpenTableTupleScheme getScheme() {
      return new TOpenTableTupleScheme();
    }
  }

  private static class TOpenTableTupleScheme extends TupleScheme<TOpenTable> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TOpenTable struct) throws org.apache.thrift.TException {
