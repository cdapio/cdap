...
#send data
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'ajai bought 1 apple for $1'
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'ajai bought 1 apple for $1'
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'edwin bought 1 apple for $1'
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'edwin bought 1 apple for $1'
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'andrew bought 1 apple for $1'
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'andrew bought 1 apple for $1'
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'rohit bought 1 apple for $1'
curl -v http://127.0.0.1:10000/v2/streams/purchaseStream -X POST -d 'rohit bought 1 apple for $1'
