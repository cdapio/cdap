...
angular.module(PKG.name + '.services')
  .factory('myStreamApi', function(myCdapUrl, $resource, myAuth, myHelpers) {
    ...
    },
    {
      ...
      setProperties: myHelpers.getConfig('PUT', 'REQUEST', basepath + '/properties', false, {suppressErrors: true}),
      ...
      sendEvent: myHelpers.getConfig('POST', 'REQUEST', basepath, false, {json: false, suppressErrors: true}),
