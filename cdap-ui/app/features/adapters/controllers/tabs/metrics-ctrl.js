  ...
  .controller('AdaptersDetailMetricsController', function($scope, AdapterDetail, MyDataSource, $filter, $state, MyMetricsQueryHelper) {
    ...
    function doPollMetrics(runId) {
      ...
      if (AdapterDetail.programType === 'WORKFLOWS') {
        metricParams['mapreduce'] = AdapterDetail.logsParams.mapreduceId;
      } else if (AdapterDetail.programType === 'WORKER') {
        metricParams['worker'] = AdapterDetail.logsParams.workerId;
      }
