angular.module(PKG.name + '.feature.adapters', [])
  .constant('IMPLICIT_SCHEMA', {
    ...
    syslog: '{"type":"record","name":"etlSchemaBody","fields":[{"name":"logsource","type":["string","null"]},{"name":"message","type":["string","null"]},{"name":"pid","type":["string","null"]},{"name":"program","type":["string","null"]},{"name":"timestamp","type":["string","null"]}]}'
  });
