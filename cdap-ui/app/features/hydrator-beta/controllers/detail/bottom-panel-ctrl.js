...
angular.module(PKG.name + '.feature.hydrator-beta')
  .controller('HydratorDetailBottomPanelController', function(BottomPanelStore, PipelineDetailBottomPanelActionFactory, NodeConfigStore, $scope) {
    this.tabs = [
      {
        title: 'History',
        template: '/assets/features/hydrator-beta/templates/detail/tabs/history.html'
      },
      {
        title: 'Log',
        template: '/assets/features/hydrator-beta/templates/detail/tabs/log.html'
      },
      {
        title: 'Metrics',
        template: '/assets/features/hydrator-beta/templates/detail/tabs/metrics.html'
      },
      {
        title: 'Configuration',
        template: '/assets/features/hydrator-beta/templates/detail/tabs/configuration.html'
      },
      {
        title: 'Datasets',
        template: '/assets/features/hydrator-beta/templates/detail/tabs/datasets.html'
      },
      {
        title: 'Node Configuration',
        template: '/assets/features/hydrator-beta/templates/detail/tabs/node-configuration.html'
      }
    ];
