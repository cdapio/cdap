...
angular.module(PKG.name + '.feature.hydratorplusplus', [])
  .constant('IMPLICIT_SCHEMA', {
    clf: '{"type":"record","name":"etlSchemaBody","fields":[{"name": "ts", "type": "long", "readonly": "true"}, {"name": "headers", "type": {"type": "map", "keys": "string", "values": "string"},"readonly":"true"},{"name":"remote_host","type":["string","null"]},{"name":"remote_login","type":["string","null"]},{"name":"auth_user","type":["string","null"]},{"name":"request_time","type":["string","null"]},{"name":"request","type":["string","null"]},{"name":"status","type":["int","null"]},{"name":"content_length","type":["int","null"]},{"name":"referrer","type":["string","null"]},{"name":"user_agent","type":["string","null"]}]}',
