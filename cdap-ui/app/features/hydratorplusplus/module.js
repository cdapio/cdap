...
angular.module(PKG.name + '.feature.hydratorplusplus', [])
  .constant('IMPLICIT_SCHEMA', {
    ...
    syslog: '{"type":"record","name":"etlSchemaBody","fields":[{"name": "ts", "type": "long"}, {"name": "headers", "type": {"type": "map", "keys": "string", "values": "string"}},{"name":"timestamp","type":["string","null"]},{"name":"logsource","type":["string","null"]},{"name":"program","type":["string","null"]},{"name":"message","type":["string","null"]},{"name":"pid","type":["string","null"]}]}',
