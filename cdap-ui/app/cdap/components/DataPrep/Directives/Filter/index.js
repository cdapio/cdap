...
const DIRECTIVES_MAP = {
  'KEEP': {
    ...
    'TEXTEXACTLY': 'filter-row-if-not-matched',
    'TEXTCONTAINS': 'filter-row-if-not-matched',
    'TEXTSTARTSWITH': 'filter-row-if-false',
    'TEXTENDSWITH': 'filter-row-if-false',
    'TEXTREGEX': 'filter-row-if-not-matched',
    'CUSTOMCONDITION': 'filter-row-if-false'
  },
  'REMOVE': {
    'EMPTY': 'filter-row-if-matched',
    'TEXTEXACTLY': 'filter-row-if-matched',
    'TEXTCONTAINS': 'filter-row-if-matched',
    'TEXTSTARTSWITH': 'filter-row-if-true',
    'TEXTENDSWITH': 'filter-row-if-true',
    'TEXTREGEX': 'filter-row-if-matched',
    'CUSTOMCONDITION': 'filter-row-if-true'
  }
};
