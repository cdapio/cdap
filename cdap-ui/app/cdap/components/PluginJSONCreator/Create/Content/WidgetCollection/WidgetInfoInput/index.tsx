...
interface IWidgetInfoInputProps extends WithStyles<typeof styles>, ICreateContext {
  widgetID: number;
}

const WidgetInfoInputView: React.FC<IWidgetInfoInputProps> = ({
  classes,
  widgetID,
  widgetInfo,
  setWidgetInfo,
  ...
  return (
    <If condition={widgetInfo[widgetID] !== undefined}>
      <div className={classes.WidgetInfoInput}>
