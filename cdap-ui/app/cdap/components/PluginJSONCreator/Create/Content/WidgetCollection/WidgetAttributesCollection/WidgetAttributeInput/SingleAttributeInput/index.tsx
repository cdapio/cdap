...
import AttributeKeyValueInput from 'components/PluginJSONCreator/Create/Content/WidgetCollection/WidgetAttributesCollection/WidgetAttributeInput/SingleAttributeInput/AttributeKeyValueInput';
...
export const SingleAttributeInput = ({
  ...
  const onAttributeValueChange = (newVal) => {
    setLocalWidgetToAttributes(fromJS(localWidgetToAttributes).setIn([widgetID, field], newVal));
  };
