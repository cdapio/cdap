...
const WidgetCollectionView: React.FC<IWidgetCollectionProps> = ({
  ...
  function addWidgetToGroup(index: number) {
    return () => {
      ...
      setWidgetToAttributes(widgetToAttributes.set(newWidgetID, fromJS({})));
    };
  }
  ...
  function deleteWidgetFromGroup(widgetIndex) {
    return () => {
      ...
      const newWidgetsToInfo = fromJS(widgetInfo).delete(widgetToDelete);
      setWidgetInfo(newWidgetsToInfo);

      const restWidgetToAttributes = fromJS(widgetToAttributes).delete(widgetToDelete);
    ...
    <div className={classes.nestedWidgets} data-cy="widget-wrapper-container">
      ...
      <div className={classes.widgetContainer}>
        {activeWidgets.map((widgetID, widgetIndex) => {
          return (
            <If key={widgetIndex} condition={widgetInfo.get(widgetID) !== undefined}>
