  ...
  render() {
    ...
    return (
      <div className="global-navbar">
        ...
        <div
          className={classnames('global-navbar-collapse', {
        ...
        >
          <div className="navbar-right-section">
            <ul>
               ...
               */}
              <li id="header-namespace-dropdown" className="with-pointer namespace-dropdown-holder">
                {!this.props.nativeLink ? <NamespaceDropdown /> : <NamespaceDropdown tag="a" />}
              </li>
              {/**
              ...
              >
                <ProductDropdown nativeLink={this.props.nativeLink} />
              </li>
            </ul>
          </div>
        </div>
