...
export default class PlusButton extends Component {
  ...
  constructor(props) {
    ...
    if (this.props.mode === PlusButton.MODE.resourcecenter) {
      this.eventemitter.on(globalEvents.OPENPLUSBUTTON, this.toggleModal);
      this.eventemitter.on(globalEvents.CLOSEPLUSBUTTON, this.toggleModal);
    }
  }
  ...
  componentWillUnmount() {
    ...
    if (this.props.mode === PlusButton.MODE.resourcecenter) {
      this.eventemitter.off(globalEvents.OPENPLUSBUTTON, this.toggleModal);
      this.eventemitter.off(globalEvents.CLOSEPLUSBUTTON, this.toggleModal);
    }
  }
