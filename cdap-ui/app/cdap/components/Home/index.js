...
const PluginCreator = Loadable({
  loader: () => import(/* webpackChunkMame: "PluginCreator" */ 'components/PluginCreator'),
  loading: LoadingSVGCentered,
});
    ...
    return (
      <div>
        <Switch>
          ...
          />
          <Route path="/ns/:namespace/plugincreation" component={PluginCreator} />
