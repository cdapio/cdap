...
import SourceList from 'components/PluginCreator/List/SourceList';
import { Route, Switch, NavLink } from 'react-router-dom';
import { basepath } from 'components/PluginCreator';
import Deployed from 'components/PluginCreator/List/Deployed';
import Drafts from 'components/PluginCreator/List/Drafts';
import { getCurrentNamespace } from 'services/NamespaceStore';
import { PluginCardHeight } from 'components/PluginCreator/List/PluginCard';
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.linkContainer}>
        <NavLink
          exact
          to={`/ns/${getCurrentNamespace()}/plugincreation`}
        ...
        <NavLink
          exact
          to={`/ns/${getCurrentNamespace()}/plugincreation/drafts`}
          activeClassName={classes.activeLink}
          className={classes.link}
        >
          Drafts
