...
const UNDERLYING_TYPE = 'string';

const JSON_FORMAT: IJsonResponse = {
  type: UNDERLYING_TYPE,
  logicalType: LogicalTypes.DATETIME,
};

export default class DateTimeLogicalType extends AbstractLogicalType {
  constructor(attrs, opts) {
    super(attrs, opts, [cdapavsc.types.StringType], JSON_FORMAT);
  }

  public getTypeName(): string {
    return LogicalTypes.DATETIME;
  }
