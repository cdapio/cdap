...
const UNDERLYING_TYPE = 'long';
const JSON_FORMAT: IJsonResponse = {
  type: UNDERLYING_TYPE,
  logicalType: LogicalTypes.TIMESTAMP_MICROS,
};

export default class TimestampMicrosLogicalType extends AbstractLogicalType {
  constructor(attrs, opts) {
    super(attrs, opts, [cdapavsc.types.LongType], JSON_FORMAT);
  }

  public getTypeName(): string {
    return LogicalTypes.TIMESTAMP_MICROS;
  }
